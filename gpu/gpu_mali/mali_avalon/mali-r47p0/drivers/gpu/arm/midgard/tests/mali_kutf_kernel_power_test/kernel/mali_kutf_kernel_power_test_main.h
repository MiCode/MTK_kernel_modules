...
#ifndef _KUTF_KERNEL_POWER_TEST_MAIN_H_
#define _KUTF_KERNEL_POWER_TEST_MAIN_H_

#include <kutf/kutf_suite.h>
#include <mali_kbase.h>

struct kutf_kernel_power_fixture_data {
...
#endif /* _KUTF_KERNEL_POWER_TEST_MAIN_H_ */
