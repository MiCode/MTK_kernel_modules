...
/**
 * struct kbase_mmu_flush_param  - parameters for kbase_mmu_hw_do_flush()
...
/**
 * kbase_mmu_hw_do_lock - Issue LOCK command to the MMU and wait for it
 ...
 * @vpfn:       MMU Virtual Page Frame Number.
 * @nr:         Number of pages.
 * @cmd:        Command to issue to the MMU.
 * @kctx_id:        Kernel context ID for MMU command tracepoint.
 * @mmu_sync_info:  Indicates whether this call is synchronous wrt MMU ops.
 * @flush_skip_levels: Page table levels to skip for MMU operation. (Only
 *                     applicable if GPU supports feature)
 *
 * Issue a flush operation on the address space that is associated with the
 * provided kbase_context over the specified range.
 *
 * Return: Zero if the operation was successful, non-zero otherwise.
 *         Also returns the address of the memory region locked.
 */
