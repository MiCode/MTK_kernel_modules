...
{
	WCN_DBG(FM_NTC | CHIP, "default low_ops_register\n");
	return -1;
}

signed int  __weak fm_low_ops_unregister(struct fm_basic_interface *bi)
{
	WCN_DBG(FM_NTC | CHIP, "default low_ops_unregister\n");
	return -1;
}
...
{
	WCN_DBG(FM_NTC | CHIP, "default rds_ops_register\n");
	return -1;
}

signed int __weak fm_rds_ops_unregister(struct fm_rds_interface *ri)
{
	WCN_DBG(FM_NTC | CHIP, "default rds_ops_unregister\n");
	return -1;
}
