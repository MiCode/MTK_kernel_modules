...
int g_mapped_reg_table_sz_mt6789 = 15;
struct reg_map_addr g_mapped_reg_table_mt6789[] = {
...
INT32 dump_conn_debug_dump_mt6789(const char *trg_str)
{
...
INT32 dump_conn_mcu_debug_flag_mt6789(const char *trg_str)
{
	 return execute_dump_action(trg_str
				, "conn_mcu_debug_flag"
...
INT32 dump_conn_mcu_ahb_bus_hang_layer1_mt6789(const char *trg_str)
{
	 return execute_dump_action(trg_str
...
INT32 dump_conn_mcu_ahb_bus_hang_layer2_mt6789(const char *trg_str)
{
	 return execute_dump_action(trg_str
...
INT32 dump_conn_mcu_ahb_bus_hang_layer3_mt6789(const char *trg_str)
{
	 return execute_dump_action(trg_str
...
INT32 dump_conn_mcu_ahb_bus_hang_layer4_mt6789(const char *trg_str)
{
	 return execute_dump_action(trg_str
...
INT32 dump_conn_mcu_ahb_timeout_info_mt6789(const char *trg_str)
{
	 return execute_dump_action(trg_str
...
INT32 dump_conn_bus_hang_debug_mt6789(const char *trg_str)
{
	 return execute_dump_action(trg_str
				, "conn_bus_hang_debug"
...
INT32 dump_conn_mcu_apb_timeout_info_mt6789(const char *trg_str)
{
	 return execute_dump_action(trg_str
...
INT32 dump_conn_apb_bus0_hang_mt6789(const char *trg_str)
{
	 return execute_dump_action(trg_str
				, "conn_apb_bus0_hang"
...
INT32 dump_conn_apb_bus1_hang_mt6789(const char *trg_str)
{
	 return execute_dump_action(trg_str
				, "conn_apb_bus1_hang"
...
INT32 dump_conn_apb_bus2_hang_mt6789(const char *trg_str)
{
	 return execute_dump_action(trg_str
				, "conn_apb_bus2_hang"
...
INT32 dump_conn_emi_ctrl_host_csr_mt6789(const char *trg_str)
{
	 return execute_dump_action(trg_str
...
INT32 dump_conn_mcu_confg_emi_ctrl_mt6789(const char *trg_str)
{
	 return execute_dump_action(trg_str
...
INT32 dump_conn_mcu_pc_log_mt6789(const char *trg_str)
{
	 return execute_dump_action(trg_str
				, "conn_mcu_pc_log"
				, g_conn_mcu_pc_log
...
INT32 dump_conn_mcu_cpu_probe_mt6789(const char *trg_str)
{
	 return execute_dump_action(trg_str
				, "conn_mcu_cpu_probe"
...
INT32 dump_conn_mcu_ahb_probe_mt6789(const char *trg_str)
{
	 return execute_dump_action(trg_str
				, "conn_mcu_ahb_probe"
...
INT32 dump_conn_mcu_idlm_prot_prob_mt6789(const char *trg_str)
{
	 return execute_dump_action(trg_str
...
INT32 dump_conn_mcu_wf_cmdbt_ram_prob_mt6789(const char *trg_str)
{
	 return execute_dump_action(trg_str
...
INT32 dump_conn_mcu_pda_dbg_flag_mt6789(const char *trg_str)
{
	 return execute_dump_action(trg_str
...
INT32 dump_conn_mcu_sysram_prb_mt6789(const char *trg_str)
{
	 return execute_dump_action(trg_str
				, "conn_mcu_sysram_prb"
...
INT32 dump_conn_mcu_confg_mt6789(const char *trg_str)
{
	 return execute_dump_action(trg_str
				, "conn_mcu_confg"
				, g_conn_mcu_confg
...
INT32 dump_conn_mcu_i_eidlm_mt6789(const char *trg_str)
{
	 return execute_dump_action(trg_str
				, "conn_mcu_i_eidlm"
				, g_conn_mcu_i_eidlm
...
INT32 dump_conn_mcu_dma_mt6789(const char *trg_str)
{
	 return execute_dump_action(trg_str
				, "conn_mcu_dma"
				, g_conn_mcu_dma
...
INT32 dump_conn_mcu_tcm_prob_mt6789(const char *trg_str)
{
	 return execute_dump_action(trg_str
				, "conn_mcu_tcm_prob"
				, g_conn_mcu_tcm_prob
...
INT32 dump_conn_mcu_met_prob_mt6789(const char *trg_str)
{
	 return execute_dump_action(trg_str
				, "conn_mcu_met_prob"
				, g_conn_mcu_met_prob
...
INT32 dump_conn_mcusys_n9_mt6789(const char *trg_str)
{
	 return execute_dump_action(trg_str
				, "conn_mcusys_n9"
				, g_conn_mcusys_n9
...
INT32 dump_conn_mcu_uart_dbg_loop_mt6789(const char *trg_str)
{
	 return execute_dump_action(trg_str
...
INT32 dump_conn_cfg_on_Debug_Signal_mt6789(const char *trg_str)
{
	 return execute_dump_action(trg_str
...
INT32 dump_conn_cfg_on_register_mt6789(const char *trg_str)
{
	 return execute_dump_action(trg_str
...
INT32 dump_conn_cmdbt_debug_signal_mt6789(const char *trg_str)
{
	 return execute_dump_action(trg_str
...
INT32 dump_conn_cmdbt_register_mt6789(const char *trg_str)
{
	 return execute_dump_action(trg_str
				, "conn_cmdbt_register"
...
INT32 dump_conn_emi_detect_mt6789(const char *trg_str)
{
	 return execute_dump_action(trg_str
				, "conn_emi_detect"
				, g_conn_emi_detect
...
INT32 dump_conn_cmdbt_debug_mt6789(const char *trg_str)
{
	 return execute_dump_action(trg_str
				, "conn_cmdbt_debug"
				, g_conn_cmdbt_debug
...
INT32 dump_conn_hif_reg_debug_mt6789(const char *trg_str)
{
	 return execute_dump_action(trg_str
				, "conn_hif_reg_debug"
...
INT32 dump_conn_mcu_confg_bus_hang_reg_mt6789(const char *trg_str)
{
	 return execute_dump_action(trg_str
...
INT32 dump_wf_pdma_reg_debug_mt6789(const char *trg_str)
{
	 return execute_dump_action(trg_str
				, "wf_pdma_reg_debug"
				, g_wf_pdma_reg_debug
...
INT32 dump_conn_to_EMI_bus_path_mt6789(const char *trg_str)
{
	 return execute_dump_action(trg_str
