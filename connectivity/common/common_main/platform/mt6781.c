...
static UINT64 consys_timestamp_get(VOID);
/*******************************************************************************
*                            P U B L I C   D A T A
********************************************************************************
*/
...
WMT_CONSYS_IC_OPS consys_ic_ops = {
	...
	.consys_ic_timestamp_get = consys_timestamp_get,
};
...
#define TICK_PER_MS	(13000)
	...
	timestamp = ((((UINT64)tick_h << 32) & 0xFFFFFFFF00000000) | ((UINT64)tick_l & 0x00000000FFFFFFFF));
