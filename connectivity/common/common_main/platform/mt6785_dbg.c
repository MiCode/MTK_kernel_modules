...
struct consys_dump_item g_conn_mcu_apb0_bus[] = {
...
INT32 dump_conn_bus_timeout(const char *trg_str)
{
...
INT32 dump_conn_ILM_corrupt_issue_debug(const char *trg_str)
{
