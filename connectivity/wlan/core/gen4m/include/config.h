...
#define CFG_SUPPORT_PREFER_P2P_CH	1
...
#ifndef CFG_SUPPORT_ANT_HALF
#define CFG_SUPPORT_ANT_HALF 1
#endif

#ifndef CFG_SUPPORT_CONNSYS_THERMAL
#define CFG_SUPPORT_CONNSYS_THERMAL     1
#endif
...
#ifndef CFG_SUPPORT_HOTSPOT_VENDOR_SPEC
#define CFG_SUPPORT_HOTSPOT_VENDOR_SPEC       1
#endif
...
#ifndef CFG_RECONNECT_DEAUTH_AP
#define CFG_RECONNECT_DEAUTH_AP 1
#endif
/*------------------------------------------------------------------------------
...
// MIUI ADD
#define CFG_QOS_ENABLE 1
#if CFG_QOS_ENABLE
#define CW_MIN_VALUE 0
#define CW_MAX_VALUE 32767
#define AIFSN_MIN_VALUE 2
#define AIFSN_MAX_VALUE 15
#define TXOPLIMIT_MIN_VALUE 0
#define TXOPLIMIT_MAX_VALUE 65535
#define INVALID_WMM_PARAM(value, min, max) \
	(((value) < (min)) || ((value) >= (max)))
#define OUT_OF_MAX_VALUE(value, max) ((value) >= (max))
#endif
/*------------------------------------------------------------------------------
