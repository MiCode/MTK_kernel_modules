...
/* P_P2P_FSM_INFO_T prP2pFsmInfo; */
	...
	// MIUI ADD: Start
	u_int32_t u4FullToPartialPeriod;
	// MIUI End
...
// MIUI ADD
#if CFG_QOS_ENABLE
	uint8_t fgEnableWmmParams;
	uint16_t u2WmmParamVoCWmin;
	uint16_t u2WmmParamVoCWmax;
	uint16_t u2WmmParamVoTxopLimit;
	uint16_t u2WmmParamVoAifsn;
	uint16_t u2WmmParamViCWmin;
	uint16_t u2WmmParamViCWmax;
	uint16_t u2WmmParamViTxopLimit;
	uint16_t u2WmmParamViAifsn;
	uint16_t u2WmmParamBkCWmin;
	uint16_t u2WmmParamBkCWmax;
	uint16_t u2WmmParamBkTxopLimit;
	uint16_t u2WmmParamBkAifsn;
#endif
// END
