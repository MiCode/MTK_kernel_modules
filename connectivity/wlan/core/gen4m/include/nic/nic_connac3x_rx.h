...
#define CONNAC3X_RX_STATUS_SWRFB_TO_HOST_BIT     BIT(29)
#define CONNAC3X_RX_STATUS_SWRFB_PROCESS_BIT     BIT(30)
#define CONNAC3X_RX_STATUS_SWRFB_FREE_BIT        BIT(31)
#endif
...
#define HAL_MAC_CONNAC3X_RX_STATUS_SET_SWRFB_TO_HOST(_prHwMacRxDesc) \
((_prHwMacRxDesc)->u4DW5 |= CONNAC3X_RX_STATUS_SWRFB_TO_HOST_BIT)

#define HAL_MAC_CONNAC3X_RX_STATUS_UNSET_SWRFB_TO_HOST(_prHwMacRxDesc) \
((_prHwMacRxDesc)->u4DW5 &= ~CONNAC3X_RX_STATUS_SWRFB_TO_HOST_BIT)

#define HAL_MAC_CONNAC3X_RX_STATUS_SET_SWRFB_PROCESS(_prHwMacRxDesc) \
((_prHwMacRxDesc)->u4DW5 |= CONNAC3X_RX_STATUS_SWRFB_PROCESS_BIT)

#define HAL_MAC_CONNAC3X_RX_STATUS_UNSET_SWRFB_PROCESS(_prHwMacRxDesc) \
((_prHwMacRxDesc)->u4DW5 &= ~CONNAC3X_RX_STATUS_SWRFB_PROCESS_BIT)

#define HAL_MAC_CONNAC3X_RX_STATUS_SET_SWRFB_FREE(_prHwMacRxDesc) \
((_prHwMacRxDesc)->u4DW5 |= CONNAC3X_RX_STATUS_SWRFB_FREE_BIT)

#define HAL_MAC_CONNAC3X_RX_STATUS_UNSET_SWRFB_FREE(_prHwMacRxDesc) \
((_prHwMacRxDesc)->u4DW5 &= ~CONNAC3X_RX_STATUS_SWRFB_PROCESS_BIT)
