...
//[Revision time]   : Fri Mar 25 09:45:40 2022
...
/* =====================================================================================
  ...
  ---HOST_INT_STA_EXT (0x18024000 + 0x118)---
    ...
    rx_done_int_sts_7[26]        - (W1C) RX Queue#7 packet receive interrupt 
                                     Write 1 to clear the interrupt 
                                     Read to get the raw interrupt status
    rx_done_int_sts_13[27]       - (W1C) RX Queue#13 packet receive interrupt 
                                     Write 1 to clear the interrupt 
                                     Read to get the raw interrupt status
...
/* =====================================================================================
  ...
  ---HOST_INT_ENA_EXT (0x18024000 + 0x11C)---
    ...
    HOST_RX_DONE_INT_ENA13[27]   - (RW) RX Queue#13 packet receive interrupt
...
/* =====================================================================================
  ...
  ---WPDMA2HOST_ERR_INT_STA (0x18024000 + 0x1E8)---
    ...
    tx_dmad_mem_rng_err_int_sts[2] - (W1C) WPDMA TX DMAD address range error detection interrupt stauts, write 1 to clear the interrupt
    rx_dmad_mem_rng_err_int_sts[3] - (W1C) WPDMA RX DMAD address range error detection interrupt stauts, write 1 to clear the interrupt
    tx_pld_mem_rng_err_int_sts[4] - (W1C) WPDMA TX payload address range error detection interrupt stauts, write 1 to clear the interrupt
    rx_pld_mem_rng_err_int_sts[5] - (W1C) WPDMA RX payload address range error detection interrupt stauts, write 1 to clear the interrupt
    RESERVED6[31..6]             - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---WPDMA2HOST_ERR_INT_ENA (0x18024000 + 0x1EC)---
    ...
    tx_dmad_mem_rng_err_int_ena[2] - (RW) WPDMA TX DMAD address range error detection interrupt enable
    rx_dmad_mem_rng_err_int_ena[3] - (RW) WPDMA RX DMAD address range error detection interrupt enable
    tx_pld_mem_rng_err_int_ena[4] - (RW) WPDMA TX payload address range error detection interrupt enable
    rx_pld_mem_rng_err_int_ena[5] - (RW) WPDMA RX payload address range error detection interrupt enable
    RESERVED6[31..6]             - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---WPDMA_RX_RING13_CTRL0 (0x18024000 + 0x5D0)---
...
/* =====================================================================================
  ...
  ---WPDMA_RX_RING13_CTRL1 (0x18024000 + 0x5D4)---
...
/* =====================================================================================
  ...
  ---WPDMA_RX_RING13_CTRL2 (0x18024000 + 0x5D8)---
...
/* =====================================================================================
  ...
  ---WPDMA_RX_RING13_CTRL3 (0x18024000 + 0x5DC)---
...
/* =====================================================================================
  ...
  ---WPDMA_RX_RING11_EXT_CTRL (0x18024000 + 0x6AC)---
    ...
    DISP_MAX_CNT[7..0]           - (RW)  xxx 
    RESERVED8[15..8]             - (RO) Reserved bits
    DISP_BASE_PTR[31..16]        - (RW) RXD Ring #11 Extension, to configure prefetch settings, like base_ptr means each prefetch ring's base address in internal prefetch sram, disp_max_cnt means each prefetch ring's depth
...
/* =====================================================================================
  ...
  ---WPDMA_RX_RING12_EXT_CTRL (0x18024000 + 0x6B0)---
    ...
    DISP_MAX_CNT[7..0]           - (RW)  xxx 
    RESERVED8[15..8]             - (RO) Reserved bits
    DISP_BASE_PTR[31..16]        - (RW) RXD Ring #12 Extension, to configure prefetch settings, like base_ptr means each prefetch ring's base address in internal prefetch sram, disp_max_cnt means each prefetch ring's depth
...
/* =====================================================================================
  ...
  ---WPDMA_RX_RING13_EXT_CTRL (0x18024000 + 0x6B4)---

    DISP_MAX_CNT[7..0]           - (RW)  xxx 
    RESERVED8[15..8]             - (RO) Reserved bits
    DISP_BASE_PTR[31..16]        - (RW) RXD Ring #13 Extension, to configure prefetch settings, like base_ptr means each prefetch ring's base address in internal prefetch sram, disp_max_cnt means each prefetch ring's depth
...
/* =====================================================================================
  ...
  ---WPDMA_RX_RING13_BKRS_CTRL0 (0x18024000 + 0xCD0)---
...
/* =====================================================================================
  ...
  ---WPDMA_RX_RING13_BKRS_CTRL1 (0x18024000 + 0xCD4)---
...
/* =====================================================================================
  ...
  ---WPDMA_RX_RING13_BKRS_CTRL2 (0x18024000 + 0xCD8)---
