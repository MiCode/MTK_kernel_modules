...
//[File]            : wf_pse_top.h
//[Revision time]   : Fri Mar 25 09:44:48 2022
...
#define WF_PSE_TOP_PSE_SEEK_CR_12_ADDR                         (WF_PSE_TOP_BASE + 0x400) // 8400
...
/* =====================================================================================
  ...
  ---INT_N9_EN_MASK (0x820c8000 + 0x08)---
    ...
    EN_HIF_Q12_NE[31]            - (RW) HIF queue 12 not empty interrupt
...
/* =====================================================================================
  ...
  ---INT_N9_STS (0x820c8000 + 0x30)---
    ...
    HIF_Q12_NE[31]               - (W1C) HIF queue 12 not empty interrupt status
...
/* =====================================================================================
  ...
  ---QUEUE_EMPTY_MASK (0x820c8000 + 0xB4)---
    ...
    HIF_12_EMPTY_MASK[20]        - (RW) Mask control of HIF queue 12 empty status
    HIF_13_EMPTY_MASK[21]        - (RW) Mask control of HIF queue 13 empty status
    HIF_14_EMPTY_MASK[22]        - (RW) Mask control of HIF queue 14 empty status
    HIF_15_EMPTY_MASK[23]        - (RW) Mask control of HIF queue 15 empty status
    HIF_16_EMPTY_MASK[24]        - (RW) Mask control of HIF queue 16 empty status
...
/* =====================================================================================
  ...
  ---QUEUE_EMPTY_1 (0x820c8000 + 0xBC)---
    ...
    HIF_16_EMPTY[12]             - (RO) HIF queue 16 empty status
    ...
    HIF_8_EMPTY[24]              - (RO) HIF queue 8 empty status
    HIF_9_EMPTY[25]              - (RO) HIF queue 9 empty status
    HIF_10_EMPTY[26]             - (RO) HIF queue 10 empty status
    HIF_11_EMPTY[27]             - (RO) HIF queue 11 empty status
    HIF_12_EMPTY[28]             - (RO) HIF queue 12 empty status
    HIF_13_EMPTY[29]             - (RO) HIF queue 13 empty status
    HIF_14_EMPTY[30]             - (RO) HIF queue 14 empty status
    HIF_15_EMPTY[31]             - (RO) HIF queue 15 empty status
...
/* =====================================================================================
  ...
  ---PG_MDP3_GROUP (0x820c8000 + 0x144)---

    MDP3_MIN_QUOTA[12..0]        - (RW) Min. quota of MDP3 group
                                     Set up the quota before releasing PSE logic reset; it should not be changed after logic reset is released.
    RESERVED13[15..13]           - (RO) Reserved bits
    MDP3_MAX_QUOTA[28..16]       - (RW) Max. quota of MDP3 group
                                     Set up the quota before releasing PSE logic reset; it should not be changed after logic reset is released.
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---FREEPG_START_END_DTIM (0x820c8000 + 0x194)---
    ...
    FREEPG_START_DTIM[12..0]     - (RW) Start page setting of DTIM free pages
    RESERVED13[15..13]           - (RO) Reserved bits
    FREEPG_END_DTIM[28..16]      - (RW) End page setting of DTIM free page
    RESERVED29[31..29]           - (RO) Reserved bits

 =====================================================================================*/
#define WF_PSE_TOP_FREEPG_START_END_DTIM_FREEPG_END_DTIM_ADDR  WF_PSE_TOP_FREEPG_START_END_DTIM_ADDR
#define WF_PSE_TOP_FREEPG_START_END_DTIM_FREEPG_END_DTIM_MASK  0x1FFF0000                // FREEPG_END_DTIM[28..16]
...
#define WF_PSE_TOP_FREEPG_START_END_DTIM_FREEPG_START_DTIM_MASK 0x00001FFF                // FREEPG_START_DTIM[12..0]
...
/* =====================================================================================
  ...
  ---PG_LMAC0_GROUP_DTIM (0x820c8000 + 0x198)---
    ...
    LMAC0_MIN_QUOTA_DTIM[12..0]  - (RW) Min. quota of LMAC 0 group in DTIM
                                     Set up the quota before releasing PSE logic reset; it should not be changed after logic reset is released.
    RESERVED13[15..13]           - (RO) Reserved bits
    LMAC0_MAX_QUOTA_DTIM[28..16] - (RW) Max. quota of LMAC 0 group in DTIM
                                     Set up the quota before releasing PSE logic reset; it should not be changed after logic reset is released.
    RESERVED29[31..29]           - (RO) Reserved bits

 =====================================================================================*/
#define WF_PSE_TOP_PG_LMAC0_GROUP_DTIM_LMAC0_MAX_QUOTA_DTIM_ADDR WF_PSE_TOP_PG_LMAC0_GROUP_DTIM_ADDR
#define WF_PSE_TOP_PG_LMAC0_GROUP_DTIM_LMAC0_MAX_QUOTA_DTIM_MASK 0x1FFF0000                // LMAC0_MAX_QUOTA_DTIM[28..16]
...
#define WF_PSE_TOP_PG_LMAC0_GROUP_DTIM_LMAC0_MIN_QUOTA_DTIM_MASK 0x00001FFF                // LMAC0_MIN_QUOTA_DTIM[12..0]
...
/* =====================================================================================
  ...
  ---PG_LMAC1_GROUP_DTIM (0x820c8000 + 0x19C)---
    ...
    LMAC1_MIN_QUOTA_DTIM[12..0]  - (RW) Min. quota of LMAC 1 group in DTIM
                                     Set up the quota before releasing PSE logic reset; it should not be changed after logic reset is released.
    RESERVED13[15..13]           - (RO) Reserved bits
    LMAC1_MAX_QUOTA_DTIM[28..16] - (RW) Max. quota of LMAC 1 group in DTIM
                                     Set up the quota before releasing PSE logic reset; it should not be changed after logic reset is released.
    RESERVED29[31..29]           - (RO) Reserved bits

 =====================================================================================*/
#define WF_PSE_TOP_PG_LMAC1_GROUP_DTIM_LMAC1_MAX_QUOTA_DTIM_ADDR WF_PSE_TOP_PG_LMAC1_GROUP_DTIM_ADDR
#define WF_PSE_TOP_PG_LMAC1_GROUP_DTIM_LMAC1_MAX_QUOTA_DTIM_MASK 0x1FFF0000                // LMAC1_MAX_QUOTA_DTIM[28..16]
...
#define WF_PSE_TOP_PG_LMAC1_GROUP_DTIM_LMAC1_MIN_QUOTA_DTIM_MASK 0x00001FFF                // LMAC1_MIN_QUOTA_DTIM[12..0]
...
/* =====================================================================================
  ...
  ---PG_MDP_GROUP_DTIM (0x820c8000 + 0x1A0)---
    ...
    MDP_MIN_QUOTA_DTIM[12..0]    - (RW) Min. quota of MDP group in DTIM
                                     Set up the quota before releasing PSE logic reset; it should not be changed after logic reset is released.
    RESERVED13[15..13]           - (RO) Reserved bits
    MDP_MAX_QUOTA_DTIM[28..16]   - (RW) Max. quota of MDP group in DTIM
                                     Set up the quota before releasing PSE logic reset; it should not be changed after logic reset is released.
    RESERVED29[31..29]           - (RO) Reserved bits

 =====================================================================================*/
#define WF_PSE_TOP_PG_MDP_GROUP_DTIM_MDP_MAX_QUOTA_DTIM_ADDR   WF_PSE_TOP_PG_MDP_GROUP_DTIM_ADDR
#define WF_PSE_TOP_PG_MDP_GROUP_DTIM_MDP_MAX_QUOTA_DTIM_MASK   0x1FFF0000                // MDP_MAX_QUOTA_DTIM[28..16]
...
#define WF_PSE_TOP_PG_MDP_GROUP_DTIM_MDP_MIN_QUOTA_DTIM_MASK   0x00001FFF                // MDP_MIN_QUOTA_DTIM[12..0]
...
/* =====================================================================================
  ...
  ---PSE_SEEK_CR_11 (0x820c8000 + 0x3FC)---
    ...
    CPU_DATA_OPER_ERROR_FID[12..0] - (RO) PSE CPU data operation error FID
    RESERVED13[13]               - (RO) Reserved bits
    CPU_DATA_OPER_ERROR_TYPE[15..14] - (RO) PSE CPU data operation error type
    RESERVED16[31..16]           - (RO) Reserved bits

 =====================================================================================*/
#define WF_PSE_TOP_PSE_SEEK_CR_11_CPU_DATA_OPER_ERROR_TYPE_ADDR WF_PSE_TOP_PSE_SEEK_CR_11_ADDR
#define WF_PSE_TOP_PSE_SEEK_CR_11_CPU_DATA_OPER_ERROR_TYPE_MASK 0x0000C000                // CPU_DATA_OPER_ERROR_TYPE[15..14]
...
/* =====================================================================================
  ...
  ---PSE_SEEK_CR_12 (0x820c8000 + 0x400)---

    MDP_READ_DATA_OPER_ERROR_FID[12..0] - (RO) PSE MDP read data operation error FID
    RESERVED13[13]               - (RO) Reserved bits
    MDP_READ_DATA_OPER_ERROR_TYPE[15..14] - (RO) PSE MDP read data operation error type
    MDP_WRITE_DATA_OPER_ERROR_FID[28..16] - (RO) PSE MDP write data operation error FID
    RESERVED29[29]               - (RO) Reserved bits
    MDP_WRITE_DATA_OPER_ERROR_TYPE[31..30] - (RO) PSE MDP write data operation error type

 =====================================================================================*/
#define WF_PSE_TOP_PSE_SEEK_CR_12_MDP_WRITE_DATA_OPER_ERROR_TYPE_ADDR WF_PSE_TOP_PSE_SEEK_CR_12_ADDR
#define WF_PSE_TOP_PSE_SEEK_CR_12_MDP_WRITE_DATA_OPER_ERROR_TYPE_MASK 0xC0000000                // MDP_WRITE_DATA_OPER_ERROR_TYPE[31..30]
...
#define WF_PSE_TOP_PSE_SEEK_CR_12_MDP_WRITE_DATA_OPER_ERROR_FID_MASK 0x1FFF0000                // MDP_WRITE_DATA_OPER_ERROR_FID[28..16]
...
#define WF_PSE_TOP_PSE_SEEK_CR_12_MDP_READ_DATA_OPER_ERROR_TYPE_MASK 0x0000C000                // MDP_READ_DATA_OPER_ERROR_TYPE[15..14]
...
#define WF_PSE_TOP_PSE_SEEK_CR_12_MDP_READ_DATA_OPER_ERROR_FID_MASK 0x00001FFF                // MDP_READ_DATA_OPER_ERROR_FID[12..0]
