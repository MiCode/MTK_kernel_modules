...
//[File]            : wf_ple_top.h
//[Revision time]   : Thu Nov 11 16:11:34 2021
...
/* =====================================================================================
  ...
  ---SPL_GEN_CTRL (0x820c0000 + 0x050)---
    ...
    TIMER_TH[12..8]              - (RW) Timer threshold (unit: 32TU).
    RESERVED13[14..13]           - (RO) Reserved bits
    TIMER_EN[15]                 - (RW) Timeout SPL generation control.
    ...
    SPL_STA_NUM[31..24]          - (RW) SPL STA number
...
/* =====================================================================================
  ...
  ---INT_N9_ERR_MASK_1 (0x820c0000 + 0x88)---
    ...
    EN_BN2_MACTX_HANG_ERR[20]    - (RW) Enable BN2 MACTX Ctrl FSM Hang error interrupt.
    EN_BN2_TXCMD_HANG_ERR[21]    - (RW) Enable BN2 TXCMD Ctrl FSM Hang error interrupt.
...
/* =====================================================================================
  ...
  ---HOST_REPORT0 (0x820c0000 + 0x90)---
    ...
    HOST_RPT_VER0_EN[2]          - (RW) Enable control for host report roll back to Version 2 or 4.
...
/* =====================================================================================
  ...
  ---INT_N9_ERR_STS_1 (0x820c0000 + 0x308)---
    ...
    RESERVED18[19..18]           - (RO) Reserved bits
    BN2_MACTX_HANG_ERR[20]       - (W1C) BN2 MACTX Ctrl FSM Hang error interrupt. Avoid unclear error flag,  please clear flag when logic reset.
    BN2_TXCMD_HANG_ERR[21]       - (W1C) BN2 TXCMD Ctrl FSM Hang error interrupt. Avoid unclear error flag,  please clear flag when logic reset.
    RESERVED22[31..22]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---WMMAC_PGCNT_0 (0x820c0000 + 0x450)---
    ...
    WMMAC_00_PGCNT[12..0]        - (RO) WMMAC 00 used page count
    RESERVED13[15..13]           - (RO) Reserved bits
    WMMAC_01_PGCNT[28..16]       - (RO) WMMAC 01 used page count
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---WMMAC_PGCNT_1 (0x820c0000 + 0x454)---
    ...
    WMMAC_02_PGCNT[12..0]        - (RO) WMMAC 02 used page count
    RESERVED13[15..13]           - (RO) Reserved bits
    WMMAC_03_PGCNT[28..16]       - (RO) WMMAC 03 used page count
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---WMMAC_PGCNT_2 (0x820c0000 + 0x458)---
    ...
    WMMAC_10_PGCNT[12..0]        - (RO) WMMAC 10 used page count
    RESERVED13[15..13]           - (RO) Reserved bits
    WMMAC_11_PGCNT[28..16]       - (RO) WMMAC 11 used page count
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---WMMAC_PGCNT_3 (0x820c0000 + 0x45c)---
    ...
    WMMAC_12_PGCNT[12..0]        - (RO) WMMAC 12 used page count
    RESERVED13[15..13]           - (RO) Reserved bits
    WMMAC_13_PGCNT[28..16]       - (RO) WMMAC 13 used page count
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---WMMAC_PGCNT_4 (0x820c0000 + 0x460)---
    ...
    WMMAC_20_PGCNT[12..0]        - (RO) WMMAC 20 used page count
    RESERVED13[15..13]           - (RO) Reserved bits
    WMMAC_21_PGCNT[28..16]       - (RO) WMMAC 21 used page count
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---WMMAC_PGCNT_5 (0x820c0000 + 0x464)---
    ...
    WMMAC_22_PGCNT[12..0]        - (RO) WMMAC 22 used page count
    RESERVED13[15..13]           - (RO) Reserved bits
    WMMAC_23_PGCNT[28..16]       - (RO) WMMAC 23 used page count
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---WMMAC_PGCNT_6 (0x820c0000 + 0x468)---
    ...
    WMMAC_30_PGCNT[12..0]        - (RO) WMMAC 30 used page count
    RESERVED13[15..13]           - (RO) Reserved bits
    WMMAC_31_PGCNT[28..16]       - (RO) WMMAC 31 used page count
    RESERVED29[31..29]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---WMMAC_PGCNT_7 (0x820c0000 + 0x46c)---
    ...
    WMMAC_32_PGCNT[12..0]        - (RO) WMMAC 32 used page count
    RESERVED13[15..13]           - (RO) Reserved bits
    WMMAC_33_PGCNT[28..16]       - (RO) WMMAC 33 used page count
    RESERVED29[31..29]           - (RO) Reserved bits
