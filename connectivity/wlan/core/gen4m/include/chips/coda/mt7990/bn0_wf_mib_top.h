...
//[Revision time]   : Thu Nov 11 16:08:59 2021
...
/* =====================================================================================
  ...
  ---TSCR5 (0x820ed000 + 0x6C4)---

    MU_TX_COUNT[31..0]           - (RW) This counter is increased when a MPDU is transmitted in MU mode(MUMIO MU or OFDMA MU)
...
/* =====================================================================================
  ...
  ---TSCR6 (0x820ed000 + 0x6C8)---

    MU_TX_OK_COUNT[31..0]        - (RW) This counter is increased when a MPDU is successfully transmitted in MU mode (MUMIO MU or OFDMA MU)
                                     *do not include control frame
                                     (unit : MPDU)
...
/* =====================================================================================
  ...
  ---TBSCR0 (0x820ed000 + 0x714)---
    ...
    TX_PREAMBLE_PUNCTURING_COUNT[31..0] - (RW) This counter is increased when a MPDU is transmitted that BW strategy is preamble puncturing
                                     * do not include control frame
                                     (unit : PPDU)
...
/* =====================================================================================
  ...
  ---TBSCR1 (0x820ed000 + 0x718)---
    ...
    TX_FULL_BW_COUNT[31..0]      - (RW) This counter is increased when a MPDU is transmitted that BW strategy is full BW
                                     * do not include control frame
                                     (unit : PPDU)
...
/* =====================================================================================
  ...
  ---TBSCR2 (0x820ed000 + 0x71C)---
    ...
    TX_AUTO_BW_COUNT[31..0]      - (RW) This counter is increased when a MPDU is transmitted that BW strategy is auto BW
                                     * do not include control frame
                                     (unit : PPDU)
...
/* =====================================================================================
  ...
  ---TCCSR0 (0x820ed000 + 0x764)---

    HW_BASIC_TRIG_COUNT[31..0]   - (RW) HW Basic Trigger Frame Counter
                                     (unit : MPDU)
...
/* =====================================================================================
  ...
  ---TCCSR1 (0x820ed000 + 0x768)---

    SW_BASIC_TRIG_COUNT[31..0]   - (RW) SW Basic Trigger Frame Counter
                                     (unit : MPDU)
...
/* =====================================================================================
  ...
  ---TCCSR2 (0x820ed000 + 0x76C)---

    SW_BRP_TRIG_COUNT[31..0]     - (RW) SW Beamforming Report Poll Trigger Frame Counter
                                     (unit : MPDU)
...
/* =====================================================================================
  ...
  ---TCCSR3 (0x820ed000 + 0x770)---

    HW_MUBAR_TRIG_COUNT[31..0]   - (RW) HW MU BAR Trigger Frame Counter
                                     (unit : MPDU)
...
/* =====================================================================================
  ...
  ---TCCSR4 (0x820ed000 + 0x774)---

    HW_MURTS_TRIG_COUNT[31..0]   - (RW) HW MU RTS Trigger Frame Counter
                                     (unit : MPDU)
...
/* =====================================================================================
  ...
  ---TCCSR5 (0x820ed000 + 0x778)---

    SW_BSRP_TRIG_COUNT[31..0]    - (RW) SW Buffer Status Report Poll Trigger Frame Counter
                                     (unit : MPDU)
...
/* =====================================================================================
  ...
  ---TCCSR6 (0x820ed000 + 0x77C)---

    SW_GCRMUBAR_TRIG_COUNT[31..0] - (RW) SW GCR MU BAR Trigger Frame Counter
                                     (unit : MPDU)
...
/* =====================================================================================
  ...
  ---TCCSR7 (0x820ed000 + 0x780)---

    SW_BQRP_TRIG_COUNT[31..0]    - (RW) SW Bandwidth Query Report Poll Trigger Frame Counter
                                     (unit : MPDU)
...
/* =====================================================================================
  ...
  ---TCCSR8 (0x820ed000 + 0x784)---

    SW_NDPFRP_TRIG_COUNT[31..0]  - (RW) SW NDP Feedback Report Poll Trigger Frame Counter
                                     (unit : MPDU)
