...
//[File]            : wf_uwtbl_top.h
//[Revision time]   : Mon Jan 18 15:48:25 2021
...
/* =====================================================================================
  ...
  ---WDUCR (0x820C4000 + 0x0094)---
    ...
    GROUP[6..0]                  - (RW) The selected group of key table/uwtbl
                                     128 entries for each group
    RESERVED7[30..7]             - (RO) Reserved bits
...
#define WF_UWTBL_TOP_WDUCR_GROUP_MASK                          0x0000007F                // GROUP[6..0]
...
/* =====================================================================================
  ...
  ---KTCR (0x820C4000 + 0x0098)---
    ...
    TARGET_IDX[12..0]            - (RW) Target index if write command of KTCR is performed
...
#define WF_UWTBL_TOP_KTCR_TARGET_IDX_MASK                      0x00001FFF                // TARGET_IDX[12..0]
...
/* =====================================================================================
  ...
  ---WIUCR (0x820C4000 + 0x00A0)---
    ...
    WLAN_IDX[11..0]              - (RW) Target for clearing or updating
    RESERVED12[17..12]           - (RO) Reserved bits
...
#define WF_UWTBL_TOP_WIUCR_WLAN_IDX_MASK                       0x00000FFF                // WLAN_IDX[11..0]
