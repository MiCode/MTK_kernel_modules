...
//[File]            : wf_pse_top.h
//[Revision time]   : Thu Jun 24 17:14:07 2021
...
/* =====================================================================================
  ...
  ---PG_MDP3_GROUP (0x820c8000 + 0x144)---
    ...
    MDP3_MIN_QUOTA[11..0]        - (RW) Min. quota of MDP3 group
                                     Set up the quota before releasing PSE logic reset; it should not be changed after logic reset is released.
    RESERVED12[15..12]           - (RO) Reserved bits
    MDP3_MAX_QUOTA[27..16]       - (RW) Max. quota of MDP3 group
                                     Set up the quota before releasing PSE logic reset; it should not be changed after logic reset is released.
    RESERVED28[31..28]           - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---MDP3_PG_INFO (0x820c8000 + 0x184)---
    ...
    MDP3_RSV_CNT[11..0]          - (RO) Reserved pages of MDP 3 group
    RESERVED12[15..12]           - (RO) Reserved bits
    MDP3_SRC_CNT[27..16]         - (RO) Used pages of MDP 3 group
    RESERVED28[31..28]           - (RO) Reserved bits
