...
struct CMD_VALIDATE_POLICY set_sap_fixed_rate_policy[COMMON_CMD_SET_ARG_NUM(2)] = {
	[COMMON_CMD_ATTR_IDX(1)] = {.type = NLA_U32, .min = 0, .max = 5},
};
...
struct PRIV_CMD_HANDLER priv_cmd_handlers_customer[] = {
...
#endif
	{
		.pcCmdStr  = CMD_SAP_FIXED_RATE_CHANGE,
		.pfHandler = priv_driver_sap_fixed_rate_change,
		.argPolicy = VERIFY_EXACT_ARG_NUM,
		.ucArgNum  = COMMON_CMD_SET_ARG_NUM(2),
		.policy    = set_sap_fixed_rate_policy,
		.u4PolicySize = ARRAY_SIZE(set_sap_fixed_rate_policy)
	},
#if CFG_WOW_SUPPORT
	{
...
#if CFG_SUPPORT_DYNAMIC_PWR_LIMIT
	{
        ...
        {
                .pcCmdStr  = CMD_SET_ANT_HALF,
                .pfHandler = priv_driver_set_ant_half,
                .argPolicy = VERIFY_MIN_ARG_NUM,
                .ucArgNum  = COMMON_CMD_SET_ARG_NUM(2),
                .policy    = NULL,
                .u4PolicySize = 0
        ...
        {
                .pcCmdStr  = CMD_SET_THERMAL_LEVEL,
                .pfHandler = priv_driver_set_thermal_level,
                .argPolicy = VERIFY_MIN_ARG_NUM,
                .ucArgNum  = COMMON_CMD_SET_ARG_NUM(2),
                .policy    = NULL,
                .u4PolicySize = 0
