		...
		OUT struct MSG_SCN_SCAN_REQ_V2 *prScanReqMsg)
{
	...
	if (fgIsOnlineScan && (u4ScanChannelNum == 0 ||
		...
		/* P6 code for HQFEAT-108860 by bianminghui at 2025/06/18 start
		   delete che condition "fgIsLowSpanScan"
		*/
		/* Do full scan when
		...
		*/
		if (prScanInfo->u4LastFullScanTime == 0 ||
		 ...
		 /* P6 code for HQFEAT-108860 by bianminghui at 2025/06/18 end */
