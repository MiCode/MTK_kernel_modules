...
static const uint16_t g_u2CountryGroup1[] = {
	...
	COUNTRY_CODE_NU, COUNTRY_CODE_PN, COUNTRY_CODE_PS, COUNTRY_CODE_PW,
	...
	COUNTRY_CODE_SX, COUNTRY_CODE_SY, COUNTRY_CODE_TC, COUNTRY_CODE_TK,
	COUNTRY_CODE_TO, COUNTRY_CODE_TT, COUNTRY_CODE_VC, COUNTRY_CODE_VG,
...
static const uint16_t g_u2CountryGroup5[] = {
	COUNTRY_CODE_MV, COUNTRY_CODE_VE
};
...
static const uint16_t g_u2CountryGroup15[] = {
	COUNTRY_CODE_EG, COUNTRY_CODE_MA
};
...
static const uint16_t g_u2CountryGroup18[] = {
	COUNTRY_CODE_AD, COUNTRY_CODE_AL, COUNTRY_CODE_AT, COUNTRY_CODE_BA,
	COUNTRY_CODE_BE, COUNTRY_CODE_BG, COUNTRY_CODE_CH, COUNTRY_CODE_CY,
	COUNTRY_CODE_CZ, COUNTRY_CODE_DE, COUNTRY_CODE_DK, COUNTRY_CODE_EE,
	COUNTRY_CODE_ES, COUNTRY_CODE_FI, COUNTRY_CODE_FR, COUNTRY_CODE_GR,
	COUNTRY_CODE_HR, COUNTRY_CODE_HU, COUNTRY_CODE_IE, COUNTRY_CODE_IT,
	COUNTRY_CODE_KE, COUNTRY_CODE_KW, COUNTRY_CODE_LT, COUNTRY_CODE_LU,
	COUNTRY_CODE_LV, COUNTRY_CODE_MD, COUNTRY_CODE_ME, COUNTRY_CODE_MK,
	COUNTRY_CODE_MT, COUNTRY_CODE_NL, COUNTRY_CODE_NO, COUNTRY_CODE_PL,
	COUNTRY_CODE_PT, COUNTRY_CODE_RO, COUNTRY_CODE_RS, COUNTRY_CODE_RU,
	COUNTRY_CODE_SE, COUNTRY_CODE_SI, COUNTRY_CODE_SK, COUNTRY_CODE_TJ,
	COUNTRY_CODE_TR, COUNTRY_CODE_TZ
};
static const uint16_t g_u2CountryGroup19[] = {
	COUNTRY_CODE_AE, COUNTRY_CODE_AM, COUNTRY_CODE_GB, COUNTRY_CODE_IL,
	COUNTRY_CODE_KG, COUNTRY_CODE_MO, COUNTRY_CODE_NZ, COUNTRY_CODE_PH,
	COUNTRY_CODE_QA, COUNTRY_CODE_SG, COUNTRY_CODE_ZA
};
...
static const uint16_t g_u2CountryGroup32[] = {
	...
	COUNTRY_CODE_PE, COUNTRY_CODE_SV
};
...
static const uint16_t g_u2CountryGroup39[] = {
	COUNTRY_CODE_AO, COUNTRY_CODE_BW, COUNTRY_CODE_CI, COUNTRY_CODE_GE,
	COUNTRY_CODE_IQ, COUNTRY_CODE_LB, COUNTRY_CODE_LY, COUNTRY_CODE_MZ,
	COUNTRY_CODE_SO, COUNTRY_CODE_TM
};
static const uint16_t g_u2CountryGroup40[] = {
	COUNTRY_CODE_BN, COUNTRY_CODE_BO, COUNTRY_CODE_IN, COUNTRY_CODE_KH,
	COUNTRY_CODE_LA, COUNTRY_CODE_NI, COUNTRY_CODE_PG, COUNTRY_CODE_UA,
	COUNTRY_CODE_VN
};
static const uint16_t g_u2CountryGroup41[] = {
	COUNTRY_CODE_EC, COUNTRY_CODE_PA, COUNTRY_CODE_PY
};
static const uint16_t g_u2CountryGroup42[] = {
	COUNTRY_CODE_BY, COUNTRY_CODE_MM, COUNTRY_CODE_ZW
};
...
static const uint16_t g_u2CountryGroup47[] = {
	COUNTRY_CODE_CL, COUNTRY_CODE_HN, COUNTRY_CODE_TH
};
static const uint16_t g_u2CountryGroup48[] = {
	COUNTRY_CODE_MX
};
static const uint16_t g_u2CountryGroup49[] = {
	COUNTRY_CODE_US
};
static const uint16_t g_u2CountryGroup50[] = {
	COUNTRY_CODE_TW
};
...
struct DOMAIN_INFO_ENTRY arSupportedRegDomains[] = {
	...
	,
	{
		(uint16_t *) g_u2CountryGroup49, sizeof(g_u2CountryGroup49) / 2,
		{
			{81, BAND_2G4, CHNL_SPAN_5, 1, 11, FALSE}
			,	/* CH_SET_2G4_1_11 */
			{115, BAND_5G, CHNL_SPAN_20, 36, 4, FALSE}
	...
	,
	{
		(uint16_t *) g_u2CountryGroup50, sizeof(g_u2CountryGroup50) / 2,
		{
			{81, BAND_2G4, CHNL_SPAN_5, 1, 11, FALSE}
			,	/* CH_SET_2G4_1_11 */
			{115, BAND_5G, CHNL_SPAN_20, 36, 4, FALSE}
...
#if CFG_SUPPORT_LOAD_SAR_BY_HWID
/*****************************************************************************
* Get HW ID functions
* read node: /proc/device-tree/chosen/bootargs
* node output ex: ...hwid.project_name=klee hwid.hwid_value=2162688...
* return value : CN 0, GL 1, IN 2, JP 3, INVALID 4
*****************************************************************************/
static uint32_t get_hwid_from_dtb(void) {
	struct device_node *proj_info_node;
	const char *read_hwc;
	char *this_char = NULL;
	int res = -1;
	char hwc_word[] = "hwid.hwid_value=";
	unsigned int decimal_value;
	uint32_t hex_value;
	uint32_t country_code = (uint32_t)HWID_INVALID;

	proj_info_node = of_find_node_by_name(NULL,"chosen");
	if (NULL == proj_info_node) {
		DBGLOG(RLM, ERROR,"device chosen node not exist.");
		return country_code;
	}
	res = of_property_read_string(proj_info_node,"bootargs",&read_hwc);
	if (res != 0) {
		DBGLOG(RLM, ERROR,"read bootargs fail:res=%d.",res);
		return country_code;
	}
	DBGLOG(RLM, INFO,"get bootargs success, bootargs=%s.\n",read_hwc);

	this_char = strstr(read_hwc, hwc_word);
	if (this_char != NULL) {
		if (sscanf(this_char, "hwid.hwid_value=%d", &decimal_value) == 1) {
			hex_value = (uint32_t)decimal_value;
			country_code = (hex_value & HW_COUNTRY_VERSION_MASK) >> HW_COUNTRY_VERSION_SHIFT;
			DBGLOG(RLM, INFO,
				"hwid.hwid_value= %u, hex= %x, country=%x.\n",
				decimal_value,
				hex_value,
				country_code);
			return country_code;
		}
		DBGLOG(RLM, ERROR,"sscanf get hwid.hwid_value failed.");
	}
	DBGLOG(RLM, ERROR,"strstr get hwid.hwid_value failed.");
	return country_code;
}
#endif
...
void txPwrCtrlCfgFileToList(struct ADAPTER *prAdapter)
{
	...
	uint32_t u4ConfigReadLen = 0;
#if CFG_SUPPORT_LOAD_SAR_BY_HWID
	/* The certification standards vary in different regions. 
	Load different SAR parameters based on HWID in order
	to avoid sacrificing performance. */
	uint32_t country_id = (uint32_t)HWID_INVALID;

	country_id = get_hwid_from_dtb();
	const char *config_file = NULL;

	switch (country_id) {
		case (uint32_t)HWID_IN:
			config_file = "txpowerctrl_in.cfg";
			break;
		default:
			config_file = "txpowerctrl.cfg";
			break;
	}
	if (kalRequestFirmware(config_file, &pucConfigBuf,
