...
#if CFG_SUPPORT_HOTSPOT_VENDOR_SPEC
	INIT_UINT(prWifiVar->ucMiSapOui, "MiSapOui", FEATURE_DISABLED,
		  FEATURE_TO_CUSTOMER);
#endif
...
#undef __STR_MIN_RESERVED
	...
	INIT_UINT(prWifiVar->fgDeauthBlkByLink, "DeauthBlocklistByLink", 0,
		  FEATURE_TO_CUSTOMER);
...
// MIUI ADD
#if (CFG_RECONNECT_DEAUTH_AP == 1)
	INIT_UINT(prWifiVar->ucReconnectDeauthAP,
                  "ReconnectDeauthAP", FEATURE_ENABLED, FEATURE_TO_CUSTOMER);
#endif
// END
...
// MIUI ADD
#if CFG_QOS_ENABLE
	prWifiVar->fgEnableWmmParams = (uint8_t) wlanCfgGetUint32(
		prAdapter, "EnableWmmParams", FEATURE_DISABLED, FEATURE_TO_CUSTOMER);
	INIT_UINT(prWifiVar->u2WmmParamVoCWmin, "WmmParamVoCWmin", CW_MAX_VALUE,
		FEATURE_TO_CUSTOMER);
	INIT_UINT(prWifiVar->u2WmmParamVoCWmax, "WmmParamVoCWmax", CW_MAX_VALUE,
		FEATURE_TO_CUSTOMER);
	INIT_UINT(prWifiVar->u2WmmParamVoTxopLimit, "WmmParamVoTxopLimit",
		TXOPLIMIT_MAX_VALUE, FEATURE_TO_CUSTOMER);
	INIT_UINT(prWifiVar->u2WmmParamVoAifsn, "WmmParamVoAifsn", AIFSN_MAX_VALUE,
		FEATURE_TO_CUSTOMER);
	INIT_UINT(prWifiVar->u2WmmParamViCWmin, "WmmParamViCWmin", CW_MAX_VALUE,
		FEATURE_TO_CUSTOMER);
	INIT_UINT(prWifiVar->u2WmmParamViCWmax, "WmmParamViCWmax", CW_MAX_VALUE,
		FEATURE_TO_CUSTOMER);
	INIT_UINT(prWifiVar->u2WmmParamViTxopLimit, "WmmParamViTxopLimit",
		TXOPLIMIT_MAX_VALUE, FEATURE_TO_CUSTOMER);
	INIT_UINT(prWifiVar->u2WmmParamViAifsn, "WmmParamViAifsn", AIFSN_MAX_VALUE,
		FEATURE_TO_CUSTOMER);
	INIT_UINT(prWifiVar->u2WmmParamBkCWmin, "WmmParamBkCWmin", CW_MAX_VALUE,
		FEATURE_TO_CUSTOMER);
	INIT_UINT(prWifiVar->u2WmmParamBkCWmax, "WmmParamBkCWmax", CW_MAX_VALUE,
		FEATURE_TO_CUSTOMER);
	INIT_UINT(prWifiVar->u2WmmParamBkTxopLimit, "WmmParamBkTxopLimit",
		TXOPLIMIT_MAX_VALUE, FEATURE_TO_CUSTOMER);
	INIT_UINT(prWifiVar->u2WmmParamBkAifsn, "WmmParamBkAifsn", AIFSN_MAX_VALUE,
		FEATURE_TO_CUSTOMER);
#endif
// END
	...
	INIT_UINT(prWifiVar->fgEnP2pPref6g, "EnP2pPref6g", FEATURE_ENABLED,
		  FEATURE_TO_CUSTOMER);
	// MIUI ADD: Start
	INIT_UINT(prWifiVar->u4FullToPartialPeriod, "FullToPartialPeriod",
			CFG_SCAN_FULL2PARTIAL_PERIOD, FEATURE_TO_CUSTOMER);
	// MIUI END
}
