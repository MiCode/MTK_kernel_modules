...
#undef __STR_MIN_RESERVED
	...
	INIT_UINT(prWifiVar->fgTdlsDisable,
		"TdlsDisable", FEATURE_ENABLED, FEATURE_DEBUG_ONLY);
...
#endif
	INIT_INT(prWifiVar->cVeryLowRSSI, "VeryLowRSSI",
		VERY_LOW_RSSI_FOR_5G_BAND, FEATURE_TO_CUSTOMER);
	...
	INIT_UINT(prWifiVar->fgMlrDisSingleLink2g,
		"MlrDisSingleLink2g", FEATURE_ENABLED, FEATURE_TO_CUSTOMER);
#endif
	...
	INIT_INT(prWifiVar->iLowRssiThr5gBand, "LowRssiThr5gBand",
				LOW_RSSI_FOR_5G_BAND, FEATURE_TO_CUSTOMER);
#endif
