...
#if defined(MT6639) && CFG_DBDC_MODE
	/* DBDC chip not support this */
	if ((band_mode == TEST_BAND_MODE_SINGLE) && (band_type == TEST_BAND_TYPE_UNUSE)) {
		SERV_LOG(SERV_DBG_CAT_TEST, SERV_DBG_LVL_OFF,
			("%s: not support band_mode=%u, band_type=%u\n",
