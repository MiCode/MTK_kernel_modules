...
prWifiVar->uc11BDynamicEnable = (uint8_t) wlanCfgGetUint32(
	...
	prWifiVar->auc6GPwrModeRuleEn[PWR_MODE_6XD] =
		(uint8_t) wlanCfgGetUint32(
		prAdapter, "6GPwrModeEnable6XD", FEATURE_DISABLED);
	prWifiVar->auc6GPwrModeRuleEn[PWR_MODE_6FX] =
		(uint8_t) wlanCfgGetUint32(
		prAdapter, "6GPwrModeEnable6FX", FEATURE_DISABLED);
	prWifiVar->auc6GPwrModeRuleEn[PWR_MODE_6CD] =
		(uint8_t) wlanCfgGetUint32(
		prAdapter, "6GPwrModeEnable6CD", FEATURE_ENABLED);
	prWifiVar->auc6GPwrModeRuleEn[PWR_MODE_6VL] =
		(uint8_t) wlanCfgGetUint32(
		prAdapter, "6GPwrModeEnable6VL", FEATURE_ENABLED);
