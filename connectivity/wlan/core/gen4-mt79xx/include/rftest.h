...
enum ENUM_RF_AT_FUNCID {
	...
	RF_AT_FUNCID_FMCW_RADAR_CONFIG = 231,
	RF_AT_FUNCID_FMCW_RADAR_ENABLE = 232,
	RF_AT_FUNCID_FMCW_RADAR_INIT = 233,
	RF_AT_FUNCID_FMCW_RADAR_TRX = 234,
	RF_AT_FUNCID_FMCW_RADAR_GET_DATA = 235,
#endif
};
...
#if CFG_SUPPORT_FMCW_RADAR
uint32_t rftestFmcwQueryATInfo(IN struct ADAPTER *prAdapter,
		uint32_t u4FuncIndex, uint32_t u4FuncData,
		OUT void *pvQueryBuffer, IN uint32_t u4QueryBufferLen);
#endif
