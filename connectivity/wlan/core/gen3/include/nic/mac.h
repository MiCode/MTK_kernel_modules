...
typedef struct _WLAN_BEACON_FRAME_T {
	...
	UINT_8 aucInfoElem[];	/* Various IEs, start from SSID */
...
typedef struct _WLAN_DISASSOC_FRAME_T {
	...
	UINT_8 aucInfoElem[];	/* Various IEs, possible no. */
...
typedef struct _WLAN_ASSOC_REQ_FRAME_T {
	...
	UINT_8 aucInfoElem[];	/* Information elements, include WPA IE */
...
typedef struct _WLAN_AUTH_FRAME_T {
	...
	UINT_16 u2StatusCode;	/* Status code */
	UINT_8 aucInfoElem[];	/* Various IEs for Fast BSS Transition */
...
typedef struct _IE_SUPPORTED_RATE_T {
	UINT_8 ucId;
	UINT_8 ucLength;
	UINT_8 aucSupportedRates[]; /* Variable size, should no more than 8 */
...
typedef struct _IE_COUNTRY_T {
	...
	COUNTRY_INFO_SUBBAND_TRIPLET_T arCountryStr[];
...
typedef struct _IE_EXT_SUPPORTED_RATE_T {
	UINT_8 ucId;
	UINT_8 ucLength;
	UINT_8 aucExtSupportedRates[]; /* Variable size */
...
typedef struct _WLAN_ACTION_FRAME {
	...
	UINT_8 ucActionDetails[];	/* Action details */
...
typedef struct _ACTION_SM_REQ_FRAME {
	...
	UINT_8 aucInfoElem[];	/* Information elements  */
...
struct ACTION_NEIGHBOR_REPORT_FRAME {
	...
	UINT_8 ucAction;	/* Action Value */
	UINT_8 ucDialogToken;	/* Dialog Token */
	UINT_8 aucInfoElem[];	/* subelements */
};
