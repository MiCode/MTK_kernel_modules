...
/*typedef UINT_32 MTK_WCN_HIF_SDIO_CLTCTX;*/

/* Callback functions provided by client driver */
typedef INT_32(*MTK_WCN_HIF_SDIO_PROBE)(UINT32, const MTK_WCN_HIF_SDIO_FUNCINFO *prFuncInfo);
typedef INT_32(*MTK_WCN_HIF_SDIO_REMOVE)(UINT32);
typedef INT_32(*MTK_WCN_HIF_SDIO_IRQ)(UINT32);
...
extern INT_32 mtk_wcn_hif_sdio_readb(UINT32 ctx, UINT_32 offset, PUINT_8 pvb);

extern INT_32 mtk_wcn_hif_sdio_writeb(UINT32 ctx, UINT_32 offset, UINT_8 vb);

extern INT_32 mtk_wcn_hif_sdio_readl(UINT32 ctx, UINT_32 offset, PUINT_32 pvl);

extern INT_32 mtk_wcn_hif_sdio_writel(UINT32 ctx, UINT_32 offset, UINT_32 vl);

extern INT_32 mtk_wcn_hif_sdio_read_buf(UINT32 ctx, UINT_32 offset, PUINT_32 pbuf, UINT_32 len);

extern INT_32 mtk_wcn_hif_sdio_write_buf(UINT32 ctx, UINT_32 offset, PUINT_32 pbuf, UINT_32 len);

extern void mtk_wcn_hif_sdio_set_drvdata(UINT32 ctx, void *private_data_p);

extern void *mtk_wcn_hif_sdio_get_drvdata(UINT32 ctx);
