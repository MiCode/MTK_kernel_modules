...
static INT_32 mtk_sdio_probe(UINT32, const MTK_WCN_HIF_SDIO_FUNCINFO *);

static INT_32 mtk_sdio_remove(UINT32);
static INT_32 mtk_sdio_interrupt(UINT32);
...
static INT_32 mtk_sdio_interrupt(UINT32 cltCtx)
{
...
static INT_32 mtk_sdio_probe(UINT32 cltCtx, const MTK_WCN_HIF_SDIO_FUNCINFO *prFuncInfo)
{
...
#if MTK_WCN_HIF_SDIO
static INT_32 mtk_sdio_remove(UINT32 cltCtx)
{
	INT_32 ret = HIF_SDIO_ERR_SUCCESS;
