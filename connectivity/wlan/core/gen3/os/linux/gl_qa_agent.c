...
static INT_32 HQA_MACBbpRegBulkRead(struct net_device *prNetDev,
				    IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	UINT_32 u4Index = 0, u4Offset = 0, u4Value = 0;
	UINT_16 u2Len = 0;
	INT_32 i4Status = 0;
	UINT_32 u4BufLen = 0;
	P_GLUE_INFO_T prGlueInfo = NULL;
...
static INT_32 HQA_RfRegBulkRead(struct net_device *prNetDev,
				IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	UINT_32 u4Index = 0, u4WfSel = 0, u4Offset = 0, u4Length = 0, u4Value = 0;
	INT_32 i4Status = 0;
	UINT_32 u4BufLen = 0;
	P_GLUE_INFO_T prGlueInfo = NULL;
	PARAM_CUSTOM_MCR_RW_STRUCT_T rMcrInfo;
...
static INT_32 HQA_RfRegBulkWrite(struct net_device *prNetDev,
				 IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	UINT_32 u4WfSel = 0, u4Offset = 0, u4Length = 0, u4Value = 0;
	INT_32 i4Status = 0;
	UINT_32 u4BufLen = 0;
	P_GLUE_INFO_T prGlueInfo = NULL;
	PARAM_CUSTOM_MCR_RW_STRUCT_T rMcrInfo;
...
{
	INT_32 i4Ret = 0;
	UINT_32 Type = 0, Enable = 0, Band = 0;
	P_GLUE_INFO_T prGlueInfo = NULL;
	WLAN_STATUS rStatus = WLAN_STATUS_SUCCESS;
	PARAM_MTK_WIFI_TEST_STRUCT_T rRfATInfo;
	UINT_32 u4BufLen = 0;
...
{
	INT_32 i4Ret = 0;
	UINT_32 col_idx0 = 0, row_idx0 = 0, col_idx1 = 0, row_idx1 = 0;
	UINT_32 col_idx2 = 0, row_idx2 = 0, col_idx3 = 0, row_idx3 = 0;
	UINT_8 *prInBuf = NULL;
...
{
	INT_32 i4Ret = 0;
	UINT_32 nrow = 0, ncol = 0, ngroup = 0, LM = 0, code_book = 0, htc_exist = 0;
	UINT_8 *prInBuf = NULL;
...
{
	INT_32 i4Ret = 0;
	UINT_32 snr_sts0 = 0, snr_sts1 = 0, snr_sts2 = 0, snr_sts3 = 0;
	UINT_8 *prInBuf = NULL;
...
{
	INT_32 i4Ret = 0;
	UINT_32 mcs_lss0 = 0, mcs_sss0 = 0, mcs_lss1 = 0, mcs_sss1 = 0, mcs_lss2 = 0, mcs_sss2 = 0;
	UINT_8 *prInBuf = NULL;
...
{
	INT_32 i4Ret = 0;
	UINT_32 wlan_idx = 0, bss_idx = 0, aid = 0;
...
{
	INT_32 i4Ret = 0;
	UINT_32 wlan_idx = 0, bss_idx = 0, PfmuId = 0, su_mu = 0, etxbf_cap = 0, ndpa_rate = 0, ndp_rate = 0;
	UINT_32 report_poll_rate = 0, tx_mode = 0, nc = 0, nr = 0, cbw = 0, spe_idx = 0, tot_mem_req = 0;
	UINT_32 mem_req_20m = 0, mem_row0 = 0, mem_col0 = 0, mem_row1 = 0, mem_col1 = 0;
	UINT_32 mem_row2 = 0, mem_col2 = 0, mem_row3 = 0, mem_col3 = 0;
	UINT_8 *prInBuf = NULL;
...
{
	INT_32 i4Ret = 0;
	UINT_32 pfmuid = 0, subcarrier = 0, phi11 = 0, psi21 = 0, phi21 = 0, psi31 = 0, phi31 = 0, psi41 = 0;
	UINT_32 phi22 = 0, psi32 = 0, phi32 = 0, psi42 = 0, phi33 = 0, psi43 = 0;
	UINT32 snr00 = 0, snr01 = 0, snr02 = 0, snr03 = 0;
	UINT_8 *prInBuf = NULL;
...
{
	INT_32 i4Ret = 0;
	UINT_32 su_mu = 0, mu_num = 0, snd_interval = 0, wlan_id0 = 0;
	UINT_32 wlan_id1 = 0, wlan_id2 = 0, wlan_id3 = 0, band_idx = 0;
	UINT_8 *prInBuf = NULL;
			      ...
			      IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	UINT_32 type = 0;
	UINT_32 wtbl_idx = 0;
	UINT_32 ownmac_idx = 0;
	UINT_32 phymode = 0;
	UINT_32 bw = 0;
	UINT_32 pfmuid = 0;
	UINT_32 marate_mode = 0;
	UINT_32 marate_mcs = 0;
	UINT_32 spe_idx = 0;
	UINT_32 aid = 0;
	UINT_8 ucAddr1[MAC_ADDR_LEN];
	UINT_32 nss = 1;
...
{
	INT_32 i4Ret = 0;
	UINT_32 u4Num_of_user = 0;
	UINT_32 u4Bandwidth = 0;
	UINT_32 u4Nss_of_user0 = 0;
	UINT_32 u4Nss_of_user1 = 0;
	UINT_32 u4Nss_of_user2 = 0;
	UINT_32 u4Nss_of_user3 = 0;
	UINT_32 u4Pf_mu_id_of_user0 = 0;
	UINT_32 u4Pf_mu_id_of_user1 = 0;
	UINT_32 u4Pf_mu_id_of_user2 = 0;
	UINT_32 u4Pf_mu_id_of_user3 = 0;
	UINT_32 u4Num_of_txer = 0;	/* number of antenna */
	UINT_32 u4Spe_index = 0;
	UINT_32 u4Group_index = 0;
	UINT_8 *prInBuf = NULL;
...
{
	INT_32 i4Ret = 0;
	UINT_32 u4GroupIndex = 0, u4NumOfUser = 0, u4User0Ldpc = 0, u4User1Ldpc = 0, u4User2Ldpc = 0, u4User3Ldpc = 0;
	UINT_32 u4ShortGI = 0, u4Bw = 0, u4User0Nss = 0, u4User1Nss = 0, u4User2Nss = 0, u4User3Nss = 0;
	UINT_32 u4GroupId = 0, u4User0UP = 0, u4User1UP = 0, u4User2UP = 0, u4User3UP = 0;
	UINT_32 u4User0MuPfId = 0, u4User1MuPfId = 0, u4User2MuPfId = 0, u4User3MuPfId = 0;
	UINT_32 u4User0InitMCS = 0, u4User1InitMCS = 0, u4User2InitMCS = 0, u4User3InitMCS = 0;
...
{
	INT_32 i4Ret = 0;
	UINT_32 u4BandIdx = 0, u4IsRandomPattern = 0;
	UINT_32 u4MsduPayloadLength0 = 0, u4MsduPayloadLength1 = 0, u4MsduPayloadLength2 = 0, u4MsduPayloadLength3 = 0;
	UINT_32 u4MuPacketCount = 0, u4NumOfSTAs = 0;
	UINT_8 ucAddr1[MAC_ADDR_LEN], ucAddr2[MAC_ADDR_LEN], ucAddr3[MAC_ADDR_LEN], ucAddr4[MAC_ADDR_LEN];
	UINT_8 *prInBuf = NULL;
...
/*	UINT_32 u4TriggerMac = 0; */	/* Temp unused */
	...
	if (u4Control == 1 && u4Trigger == 1) {
		...
		memset(&g_au4I0Data, 0, sizeof(g_au4I0Data));/* ming-chih add */
		memset(&g_au4Q0Data, 0, sizeof(g_au4Q0Data));/* ming-chih add */
...
static INT_32 HQA_IRRSetTTG(struct net_device *prNetDev, IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	INT_32 i4Ret = 0;
	UINT_32 u4Ext_id = 0;
	UINT_32 u4TTGPwrIdx = 0;
	UINT_32 u4ChFreq = 0;
	UINT_32 u4FIToneFreq = 0;
	UINT_32 u4Band = 0;
		  ...
		  IN struct iw_request_info *prIwReqInfo, IN union iwreq_data *prIwReqData, IN char *pcExtra)
{
	INT_32 i4Status = 0;
	HQA_CMD_FRAME *HqaCmdFrame;
	UINT_32 u4ATEMagicNum = 0, u4ATEId = 0, u4ATEData = 0;
