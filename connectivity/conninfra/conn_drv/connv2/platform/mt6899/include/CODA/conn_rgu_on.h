 ...
 */
//[File]            : conn_rgu_on.h
//[Revision time]   : Wed Apr 24 16:49:18 2024
...
#define CONN_RGU_ON_BASE                                       (CONN_REG_CONN_INFRA_RGU_ON_ADDR) // 0x18000000
...
/* =====================================================================================
  ...
  ---CONN_INFRA_OFF_TOP_PWR_CTL (0x18000000 + 0x000)---
    ...
    CONN_INFRA_OFF_TOP_PWR_ACK_DLY_EN[7] - (RW) CONN_INFRA_OFF_TOP power Delay Function enable
                                     0: disable, using the legacy path
                                     1: enable, using the delay function w/ delay mode selection
    CONN_INFRA_OFF_TOP_PWR_ACK_DLY_COUNTER_CFG[10..8] - (RW) CONN_INFRA_OFF_TOP power Delay Function selection
                                     CR selection/ Cycle cnt/ 26MHz/ 52MHz/ 40MHz
                                     0: delay 3T/ 0.115us/ 0.057us/ 0.75us
                                     1: delay 5T/ 0.192us/ 0.096us/ 0.125us
                                     2: delay 9T/ 0.346us/ 0.173us/ 0.225us
                                     3: delay 17T/ 0.653us/ 0.326us/ 0.425us
                                     4: delay 33T/ 1.269us/ 0.634us/ 0.825us
                                     5: delay 65T/ 2.5us/ 1.25us/ 1.625us
                                     6: delay 129T/ 4.961us/ 2.480us/ 3.225us
                                     7: delay 256T/ 9.846us/ 4.923us/ 6.4us
...
#define CONN_RGU_ON_CONN_INFRA_OFF_TOP_PWR_CTL_CONN_INFRA_OFF_TOP_PWR_ACK_DLY_COUNTER_CFG_ADDR CONN_RGU_ON_CONN_INFRA_OFF_TOP_PWR_CTL_ADDR
#define CONN_RGU_ON_CONN_INFRA_OFF_TOP_PWR_CTL_CONN_INFRA_OFF_TOP_PWR_ACK_DLY_COUNTER_CFG_MASK 0x00000700                // CONN_INFRA_OFF_TOP_PWR_ACK_DLY_COUNTER_CFG[10..8]
#define CONN_RGU_ON_CONN_INFRA_OFF_TOP_PWR_CTL_CONN_INFRA_OFF_TOP_PWR_ACK_DLY_COUNTER_CFG_SHFT 8
#define CONN_RGU_ON_CONN_INFRA_OFF_TOP_PWR_CTL_CONN_INFRA_OFF_TOP_PWR_ACK_DLY_EN_ADDR CONN_RGU_ON_CONN_INFRA_OFF_TOP_PWR_CTL_ADDR
#define CONN_RGU_ON_CONN_INFRA_OFF_TOP_PWR_CTL_CONN_INFRA_OFF_TOP_PWR_ACK_DLY_EN_MASK 0x00000080                // CONN_INFRA_OFF_TOP_PWR_ACK_DLY_EN[7]
#define CONN_RGU_ON_CONN_INFRA_OFF_TOP_PWR_CTL_CONN_INFRA_OFF_TOP_PWR_ACK_DLY_EN_SHFT 7
...
/* =====================================================================================
  ...
  ---WFSYS_ON_TOP_PWR_CTL (0x18000000 + 0x010)---
    ...
    WFSYS_ON_TOP_PWR_ACK_DLY_EN[9] - (RW) WFSYS_ON_TOP power Delay Function enable
                                     0: disable, using the legacy path
                                     1: enable, using the delay function w/ delay mode selection
    WFSYS_ON_TOP_PWR_ACK_DLY_COUNTER_CFG[12..10] - (RW) WFSYS_ON_TOP power Delay Function selection
                                     CR selection/ Cycle cnt/ 26MHz/ 52MHz/ 40MHz
                                     0: delay 3T/ 0.115us/ 0.057us/ 0.75us
                                     1: delay 5T/ 0.192us/ 0.096us/ 0.125us
                                     2: delay 9T/ 0.346us/ 0.173us/ 0.225us
...
#define CONN_RGU_ON_WFSYS_ON_TOP_PWR_CTL_WFSYS_ON_TOP_PWR_ACK_DLY_COUNTER_CFG_ADDR CONN_RGU_ON_WFSYS_ON_TOP_PWR_CTL_ADDR
#define CONN_RGU_ON_WFSYS_ON_TOP_PWR_CTL_WFSYS_ON_TOP_PWR_ACK_DLY_COUNTER_CFG_MASK 0x00001C00                // WFSYS_ON_TOP_PWR_ACK_DLY_COUNTER_CFG[12..10]
#define CONN_RGU_ON_WFSYS_ON_TOP_PWR_CTL_WFSYS_ON_TOP_PWR_ACK_DLY_COUNTER_CFG_SHFT 10
#define CONN_RGU_ON_WFSYS_ON_TOP_PWR_CTL_WFSYS_ON_TOP_PWR_ACK_DLY_EN_ADDR CONN_RGU_ON_WFSYS_ON_TOP_PWR_CTL_ADDR
#define CONN_RGU_ON_WFSYS_ON_TOP_PWR_CTL_WFSYS_ON_TOP_PWR_ACK_DLY_EN_MASK 0x00000200                // WFSYS_ON_TOP_PWR_ACK_DLY_EN[9]
#define CONN_RGU_ON_WFSYS_ON_TOP_PWR_CTL_WFSYS_ON_TOP_PWR_ACK_DLY_EN_SHFT 9
...
/* =====================================================================================
  ...
  ---BGFYS_ON_TOP_PWR_CTL (0x18000000 + 0x020)---
    ...
    BGFSYS_ON_TOP_PWR_ON_SRC[8]  - (RW) BGFSYS_ON_TOP mtcmos control sorce selection
                                     0: trigger source from BGFSYS_ON_TOP_PWR_ON
                                     1: trigger source from chip top
    BGFSYS_ON_TOP_PWR_ACK_DLY_EN[9] - (RW) BGFSYS_ON_TOP power Delay Function enable
                                     0: disable, using the legacy path
                                     1: enable, using the delay function w/ delay mode selection
    BGFSYS_ON_TOP_PWR_ACK_DLY_COUNTER_CFG[12..10] - (RW) BGFSYS_ON_TOP power Delay Function selection
                                     CR selection/ Cycle cnt/ 26MHz/ 52MHz/ 40MHz
                                     0: delay 3T/ 0.115us/ 0.057us/ 0.75us
                                     1: delay 5T/ 0.192us/ 0.096us/ 0.125us
                                     2: delay 9T/ 0.346us/ 0.173us/ 0.225us
...
#define CONN_RGU_ON_BGFYS_ON_TOP_PWR_CTL_BGFSYS_ON_TOP_PWR_ACK_DLY_COUNTER_CFG_ADDR CONN_RGU_ON_BGFYS_ON_TOP_PWR_CTL_ADDR
#define CONN_RGU_ON_BGFYS_ON_TOP_PWR_CTL_BGFSYS_ON_TOP_PWR_ACK_DLY_COUNTER_CFG_MASK 0x00001C00                // BGFSYS_ON_TOP_PWR_ACK_DLY_COUNTER_CFG[12..10]
#define CONN_RGU_ON_BGFYS_ON_TOP_PWR_CTL_BGFSYS_ON_TOP_PWR_ACK_DLY_COUNTER_CFG_SHFT 10
#define CONN_RGU_ON_BGFYS_ON_TOP_PWR_CTL_BGFSYS_ON_TOP_PWR_ACK_DLY_EN_ADDR CONN_RGU_ON_BGFYS_ON_TOP_PWR_CTL_ADDR
#define CONN_RGU_ON_BGFYS_ON_TOP_PWR_CTL_BGFSYS_ON_TOP_PWR_ACK_DLY_EN_MASK 0x00000200                // BGFSYS_ON_TOP_PWR_ACK_DLY_EN[9]
#define CONN_RGU_ON_BGFYS_ON_TOP_PWR_CTL_BGFSYS_ON_TOP_PWR_ACK_DLY_EN_SHFT 9
#define CONN_RGU_ON_BGFYS_ON_TOP_PWR_CTL_BGFSYS_ON_TOP_PWR_ON_SRC_ADDR CONN_RGU_ON_BGFYS_ON_TOP_PWR_CTL_ADDR
#define CONN_RGU_ON_BGFYS_ON_TOP_PWR_CTL_BGFSYS_ON_TOP_PWR_ON_SRC_MASK 0x00000100                // BGFSYS_ON_TOP_PWR_ON_SRC[8]
#define CONN_RGU_ON_BGFYS_ON_TOP_PWR_CTL_BGFSYS_ON_TOP_PWR_ON_SRC_SHFT 8
