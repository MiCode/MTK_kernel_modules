 ...
 */
//[File]            : conn_cfg_on.h
//[Revision time]   : Wed Apr 24 16:46:57 2024
...
#define CONN_CFG_ON_BASE                                       (CONN_REG_CONN_INFRA_CFG_ON_ADDR) // 0x18001000
...
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_ADDR       (CONN_CFG_ON_BASE + 0x388) // 1388
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_1_TOP_ADDR       (CONN_CFG_ON_BASE + 0x390) // 1390
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_2_TOP_ADDR       (CONN_CFG_ON_BASE + 0x394) // 1394
...
/* =====================================================================================
  ...
  ---OSC_MASK (0x18001000 + 0x308)---
    ...
    CONN_INFRA_WAKEUP_MAWD[29]   - (RO) "Tie0, Due to MAWD unused
                                     indicator: ""CONN_INFRA_WAKEUP_MAWD""(from host_csr)"
...
/* =====================================================================================
  ...
  ---CONN_INFRA_CFG_ON_VS2_CTL_0_TOP (0x18001000 + 0x388)---

    SWCTL_VS2_PWR_RDY[0]         - (RW) Enable sw_vs2_pwr_rdy control selection
                                     1'b0: disable
                                     1'b1: enable sw path - sw_vs2_pwr_rdy
    SWCTL_SRCCLKENA_DCXO1[1]     - (RW) Enable sw_srcclkena_dcxo1 control selection
                                     1'b0: disable
                                     1'b1: enable sw path - sw_srcclkena_dcxo1
    SWCTL_SRCCLKENA_DCXO0[2]     - (RW) Enable sw_srcclkena_dcxo0 control selection
                                     1'b0: disable
                                     1'b1: enable sw path - sw_srcclkena_dcxo0
    SWCTL_PMIC_REQ[3]            - (RW) Enable sw_pmic_req control selection
                                     1'b0: disable
                                     1'b1: enable sw path - sw_pmic_req
    SW_VS2_PWR_RDY[4]            - (RW) Enable sw_vs2_pwr_rdy
                                     1'b0: disable
                                     1'b1: enable
    SW_SRCCLKENA_DCXO1[5]        - (RW) Enable sw_srcclkena_dcxo1
                                     1'b0: disable
                                     1'b1: enable
    SW_SRCCLKENA_DCXO0[6]        - (RW) Enable sw_srcclkena_dcxo0
                                     1'b0: disable
                                     1'b1: enable
    SW_PMIC_REQ[7]               - (RW) Enable sw_pmic_req
                                     1'b0: disable
                                     1'b1: enable sw path
    ACK_FOR_VS2_PMIC_STATE_MASK[8] - (RW) mask conn_pmic_ack for VS2 FSM operation
                                     1'b0: un-mask (speed-up sleep-wakeup time when co-clock)
                                     1'b1: mask
    PWR_RDY_FOR_VS2_LEGACY_MASK[9] - (RW)  xxx
    PWR_RDY_FOR_VS2_RC_MASK_0[10] - (RW)  xxx
    PWR_RDY_FOR_VS2_RC_MASK_1[11] - (RW)  xxx
    PWR_RDY_FOR_VS2_RC_MASK_2[12] - (RW)  xxx
    PWR_RDY_FOR_VS2_RC_MASK_3[13] - (RW)  xxx
    VS2_PWR_MODE[14]             - (RW) VS2_PWR_MODE control selection
                                     1'b0 : Original Ponsot HW behavior, srcclkena_dcxo0 == srcclkena; srcclkena_dcxo1 == 1'b0, osc_rdy signal will not cat pwr_rdy signal
                                     1'b1 : New Pingus HW behavior for control VS2 voltage, srcclkena_dcxo0/ srcclkena_dcxo1 from the module of vs2_ctl (w/ sequence), osc_rdy(support mask pwr_rdy) / osc_rdy_0/1/2/3 (support mask pwr_rdy) will cat pwr_rdy
    VS2_PWR_MODE_OFF_DCXO1[15]   - (RW) VS2 PWR MODE OFF DCXO1
                                     1'h0 : disable (Default w/ Original Ponsot HW  behaviro)
                                     1'h1 : enable
    VS2_XO_EN[16]                - (RO) VS2 FSM enable
                                     1'h0 : disable
                                     1'h1 : enable
    VS2_STATE[19..17]            - (RO) VS2 FSM state
                                     3'h0: VS2_INI
                                     3'h1: VS2_ER_DCXO1
                                     3'h2: VS2_ER_DCXO0
                                     3'h3: VS2_POWER_ON
                                     ...
                                     3'h5: VS2_EF_DCXO1
                                     3'h6: VS2_POWER_OFF
    HW_CONN_SRCCLKENA_DCXO0[20]  - (RO) VS2 FSM: srcclkena_dcxo0 request to PMIF/ dcxo0 to PMIC - Voter_SEL
    HW_CONN_SRCCLKENA_DCXO1[21]  - (RO) VS2 FSM: srcclkena_dcxo1 request to PMIF/ dcxo1 to PMIC - Voter_EN
    HW_CONN_PMIC_REQ[22]         - (RO) VS2 FSM: pmic_req request to PMIC, from suspend leave.
    HW_VS2_PWR_RDY[23]           - (RO) VS2 FSM: pwr ready
                                     1'h0: disable
                                     1'h1: enable
    CONN_INFRA_VS2_OSC_EN[24]    - (RW) VS2 FSM enable OSC_EN
                                     1'b0 : SW_CONN_INFRA_VS2_OSC_ON
                                     1'b1 : CONN_INFRA_OSC_ON_d1 (hwsrc conn_srclkena_fpm3 w/ rc mode)
    SW_CONN_INFRA_VS2_OSC_ON[25] - (RW) VS2 OSC_ON sw control to enable VS2 FSM
                                     1'h0: disable
                                     1'h1: enable
    RESERVED26[31..26]           - (RO) Reserved bits

 =====================================================================================*/
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_SW_CONN_INFRA_VS2_OSC_ON_ADDR CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_ADDR
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_SW_CONN_INFRA_VS2_OSC_ON_MASK 0x02000000                // SW_CONN_INFRA_VS2_OSC_ON[25]
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_SW_CONN_INFRA_VS2_OSC_ON_SHFT 25
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_CONN_INFRA_VS2_OSC_EN_ADDR CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_ADDR
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_CONN_INFRA_VS2_OSC_EN_MASK 0x01000000                // CONN_INFRA_VS2_OSC_EN[24]
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_CONN_INFRA_VS2_OSC_EN_SHFT 24
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_HW_VS2_PWR_RDY_ADDR CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_ADDR
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_HW_VS2_PWR_RDY_MASK 0x00800000                // HW_VS2_PWR_RDY[23]
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_HW_VS2_PWR_RDY_SHFT 23
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_HW_CONN_PMIC_REQ_ADDR CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_ADDR
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_HW_CONN_PMIC_REQ_MASK 0x00400000                // HW_CONN_PMIC_REQ[22]
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_HW_CONN_PMIC_REQ_SHFT 22
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_HW_CONN_SRCCLKENA_DCXO1_ADDR CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_ADDR
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_HW_CONN_SRCCLKENA_DCXO1_MASK 0x00200000                // HW_CONN_SRCCLKENA_DCXO1[21]
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_HW_CONN_SRCCLKENA_DCXO1_SHFT 21
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_HW_CONN_SRCCLKENA_DCXO0_ADDR CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_ADDR
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_HW_CONN_SRCCLKENA_DCXO0_MASK 0x00100000                // HW_CONN_SRCCLKENA_DCXO0[20]
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_HW_CONN_SRCCLKENA_DCXO0_SHFT 20
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_VS2_STATE_ADDR CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_ADDR
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_VS2_STATE_MASK 0x000E0000                // VS2_STATE[19..17]
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_VS2_STATE_SHFT 17
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_VS2_XO_EN_ADDR CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_ADDR
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_VS2_XO_EN_MASK 0x00010000                // VS2_XO_EN[16]
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_VS2_XO_EN_SHFT 16
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_VS2_PWR_MODE_OFF_DCXO1_ADDR CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_ADDR
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_VS2_PWR_MODE_OFF_DCXO1_MASK 0x00008000                // VS2_PWR_MODE_OFF_DCXO1[15]
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_VS2_PWR_MODE_OFF_DCXO1_SHFT 15
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_VS2_PWR_MODE_ADDR CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_ADDR
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_VS2_PWR_MODE_MASK 0x00004000                // VS2_PWR_MODE[14]
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_VS2_PWR_MODE_SHFT 14
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_PWR_RDY_FOR_VS2_RC_MASK_3_ADDR CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_ADDR
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_PWR_RDY_FOR_VS2_RC_MASK_3_MASK 0x00002000                // PWR_RDY_FOR_VS2_RC_MASK_3[13]
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_PWR_RDY_FOR_VS2_RC_MASK_3_SHFT 13
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_PWR_RDY_FOR_VS2_RC_MASK_2_ADDR CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_ADDR
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_PWR_RDY_FOR_VS2_RC_MASK_2_MASK 0x00001000                // PWR_RDY_FOR_VS2_RC_MASK_2[12]
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_PWR_RDY_FOR_VS2_RC_MASK_2_SHFT 12
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_PWR_RDY_FOR_VS2_RC_MASK_1_ADDR CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_ADDR
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_PWR_RDY_FOR_VS2_RC_MASK_1_MASK 0x00000800                // PWR_RDY_FOR_VS2_RC_MASK_1[11]
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_PWR_RDY_FOR_VS2_RC_MASK_1_SHFT 11
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_PWR_RDY_FOR_VS2_RC_MASK_0_ADDR CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_ADDR
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_PWR_RDY_FOR_VS2_RC_MASK_0_MASK 0x00000400                // PWR_RDY_FOR_VS2_RC_MASK_0[10]
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_PWR_RDY_FOR_VS2_RC_MASK_0_SHFT 10
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_PWR_RDY_FOR_VS2_LEGACY_MASK_ADDR CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_ADDR
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_PWR_RDY_FOR_VS2_LEGACY_MASK_MASK 0x00000200                // PWR_RDY_FOR_VS2_LEGACY_MASK[9]
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_PWR_RDY_FOR_VS2_LEGACY_MASK_SHFT 9
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_ACK_FOR_VS2_PMIC_STATE_MASK_ADDR CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_ADDR
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_ACK_FOR_VS2_PMIC_STATE_MASK_MASK 0x00000100                // ACK_FOR_VS2_PMIC_STATE_MASK[8]
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_ACK_FOR_VS2_PMIC_STATE_MASK_SHFT 8
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_SW_PMIC_REQ_ADDR CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_ADDR
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_SW_PMIC_REQ_MASK 0x00000080                // SW_PMIC_REQ[7]
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_SW_PMIC_REQ_SHFT 7
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_SW_SRCCLKENA_DCXO0_ADDR CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_ADDR
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_SW_SRCCLKENA_DCXO0_MASK 0x00000040                // SW_SRCCLKENA_DCXO0[6]
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_SW_SRCCLKENA_DCXO0_SHFT 6
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_SW_SRCCLKENA_DCXO1_ADDR CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_ADDR
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_SW_SRCCLKENA_DCXO1_MASK 0x00000020                // SW_SRCCLKENA_DCXO1[5]
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_SW_SRCCLKENA_DCXO1_SHFT 5
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_SW_VS2_PWR_RDY_ADDR CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_ADDR
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_SW_VS2_PWR_RDY_MASK 0x00000010                // SW_VS2_PWR_RDY[4]
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_SW_VS2_PWR_RDY_SHFT 4
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_SWCTL_PMIC_REQ_ADDR CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_ADDR
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_SWCTL_PMIC_REQ_MASK 0x00000008                // SWCTL_PMIC_REQ[3]
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_SWCTL_PMIC_REQ_SHFT 3
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_SWCTL_SRCCLKENA_DCXO0_ADDR CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_ADDR
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_SWCTL_SRCCLKENA_DCXO0_MASK 0x00000004                // SWCTL_SRCCLKENA_DCXO0[2]
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_SWCTL_SRCCLKENA_DCXO0_SHFT 2
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_SWCTL_SRCCLKENA_DCXO1_ADDR CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_ADDR
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_SWCTL_SRCCLKENA_DCXO1_MASK 0x00000002                // SWCTL_SRCCLKENA_DCXO1[1]
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_SWCTL_SRCCLKENA_DCXO1_SHFT 1
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_SWCTL_VS2_PWR_RDY_ADDR CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_ADDR
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_SWCTL_VS2_PWR_RDY_MASK 0x00000001                // SWCTL_VS2_PWR_RDY[0]
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_0_TOP_SWCTL_VS2_PWR_RDY_SHFT 0

/* =====================================================================================

  ---CONN_INFRA_CFG_ON_VS2_CTL_1_TOP (0x18001000 + 0x390)---

    VS2_EDGE_F_DCXO1_STABLE_TIME[7..0] - (RW) vs2_EDGE_F_DCXO1_stable_time for conn_srclkena_dcxo1 : 1 -> 0 (falling), after  falling need stable time
    VS2_EDGE_F_DCXO0_STABLE_TIME[15..8] - (RW) vs2_EDGE_F_DCXO0_stable_time for conn_srclkena_dcxo0 : 1 -> 0 (falling), after  falling need stable time
    VS2_EDGE_R_DCXO0_STABLE_TIME[23..16] - (RW) vs2_EDGE_R_DCXO0_stable_time for conn_srclkena_dcxo0 : 0 -> 1 (rising), after  rising need stable time
    VS2_EDGE_R_DCXO1_STABLE_TIME[31..24] - (RW) vs2_EDGE_R_DCXO1_stable_time for conn_srclkena_dcxo1 : 0 -> 1 (rising), after  rising need stable time

 =====================================================================================*/
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_1_TOP_VS2_EDGE_R_DCXO1_STABLE_TIME_ADDR CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_1_TOP_ADDR
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_1_TOP_VS2_EDGE_R_DCXO1_STABLE_TIME_MASK 0xFF000000                // VS2_EDGE_R_DCXO1_STABLE_TIME[31..24]
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_1_TOP_VS2_EDGE_R_DCXO1_STABLE_TIME_SHFT 24
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_1_TOP_VS2_EDGE_R_DCXO0_STABLE_TIME_ADDR CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_1_TOP_ADDR
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_1_TOP_VS2_EDGE_R_DCXO0_STABLE_TIME_MASK 0x00FF0000                // VS2_EDGE_R_DCXO0_STABLE_TIME[23..16]
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_1_TOP_VS2_EDGE_R_DCXO0_STABLE_TIME_SHFT 16
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_1_TOP_VS2_EDGE_F_DCXO0_STABLE_TIME_ADDR CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_1_TOP_ADDR
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_1_TOP_VS2_EDGE_F_DCXO0_STABLE_TIME_MASK 0x0000FF00                // VS2_EDGE_F_DCXO0_STABLE_TIME[15..8]
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_1_TOP_VS2_EDGE_F_DCXO0_STABLE_TIME_SHFT 8
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_1_TOP_VS2_EDGE_F_DCXO1_STABLE_TIME_ADDR CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_1_TOP_ADDR
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_1_TOP_VS2_EDGE_F_DCXO1_STABLE_TIME_MASK 0x000000FF                // VS2_EDGE_F_DCXO1_STABLE_TIME[7..0]
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_1_TOP_VS2_EDGE_F_DCXO1_STABLE_TIME_SHFT 0

/* =====================================================================================

  ---CONN_INFRA_CFG_ON_VS2_CTL_2_TOP (0x18001000 + 0x394)---

    VS2_INI_STABLE_TIME[7..0]    - (RW) vs2_INI_stable_time for conn_srclkena_dcxo0/ dcxo1
    RESERVED8[31..8]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_2_TOP_VS2_INI_STABLE_TIME_ADDR CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_2_TOP_ADDR
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_2_TOP_VS2_INI_STABLE_TIME_MASK 0x000000FF                // VS2_INI_STABLE_TIME[7..0]
#define CONN_CFG_ON_CONN_INFRA_CFG_ON_VS2_CTL_2_TOP_VS2_INI_STABLE_TIME_SHFT 0
