		...
		struct conn_debug_info_mt6899 *pdbg_level_1_info)
{
	...
	/* B10 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_1_info,
		"B10", 0x18060000 + CONSYS_DBG_GEN_CONN_INFRA_WAKEPU_TOP_OFFSET_ADDR,
		CONSYS_REG_READ(CONN_HOST_CSR_TOP_BASE +
			CONSYS_DBG_GEN_CONN_INFRA_WAKEPU_TOP_OFFSET_ADDR));

	/* B11 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_1_info,
		"B11", 0x18060000 + CONSYS_DBG_GEN_CONN_INFRA_WAKEPU_WF_OFFSET_ADDR,
		CONSYS_REG_READ(CONN_HOST_CSR_TOP_BASE +
			CONSYS_DBG_GEN_CONN_INFRA_WAKEPU_WF_OFFSET_ADDR));

	/* B12 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_1_info,
		"B12", 0x18060000 + CONSYS_DBG_GEN_CONN_INFRA_WAKEPU_BT_OFFSET_ADDR,
		CONSYS_REG_READ(CONN_HOST_CSR_TOP_BASE +
			CONSYS_DBG_GEN_CONN_INFRA_WAKEPU_BT_OFFSET_ADDR));

	/* B13 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_1_info,
		"B13", 0x18060000 + CONSYS_DBG_GEN_CONN_INFRA_WAKEPU_GPS_OFFSET_ADDR,
		CONSYS_REG_READ(CONN_HOST_CSR_TOP_BASE +
			CONSYS_DBG_GEN_CONN_INFRA_WAKEPU_GPS_OFFSET_ADDR));

	/* B14 */
	update_debug_read_info_mt6899_debug_gen(pdbg_level_1_info,
		"B14", 0x18060000 + CONSYS_DBG_GEN_CONN_INFRA_WAKEPU_FM_OFFSET_ADDR,
		CONSYS_REG_READ(CONN_HOST_CSR_TOP_BASE +
