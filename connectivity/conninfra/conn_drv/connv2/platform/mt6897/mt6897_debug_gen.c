 ...
 * - [Pxxxxt]conn_infra_bus_debug_ctrl.xlsx (Modified date: 2023-06-27)
 */
		...
		struct conn_debug_info_mt6897 *pdbg_level_1_info)
{
	...
	update_debug_write_info_mt6897_debug_gen(pdbg_level_1_info,
		"34", 0x18023000 + CONSYS_DBG_GEN_CONN_INFRA_OFF_BUS_DBG_SEL_OFFSET_ADDR,
		0, 31, 0x8);

	/* 34 */
	update_debug_read_info_mt6897_debug_gen(pdbg_level_1_info,
		"34", 0x18023000 + CONSYS_DBG_GEN_CONN_INFRA_OFF_BUS_DBG_OUT_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt6897 +
			CONSYS_DBG_GEN_CONN_INFRA_OFF_BUS_DBG_OUT_OFFSET_ADDR));
}
		...
		struct conn_debug_info_mt6897 *pdbg_level_2_info)
{
	...
	/* 35 */
	update_debug_read_info_mt6897_debug_gen(pdbg_level_2_info,
		"35", 0x1800e000 + CONSYS_DBG_GEN_CONN_INFRA_ON_BUS_APB_TIMEOUT_INFO_0_OFFSET_ADDR,
		CONSYS_REG_READ(CONN_BUS_CR_ON_BASE +
			CONSYS_DBG_GEN_CONN_INFRA_ON_BUS_APB_TIMEOUT_INFO_0_OFFSET_ADDR));

	/* 36 */
	update_debug_read_info_mt6897_debug_gen(pdbg_level_2_info,
		"36", 0x1800e000 + CONSYS_DBG_GEN_CONN_INFRA_ON_BUS_APB_TIMEOUT_INFO_1_OFFSET_ADDR,
		CONSYS_REG_READ(CONN_BUS_CR_ON_BASE +
			CONSYS_DBG_GEN_CONN_INFRA_ON_BUS_APB_TIMEOUT_INFO_1_OFFSET_ADDR));

	/* 37 */
	update_debug_read_info_mt6897_debug_gen(pdbg_level_2_info,
		"37", 0x1800e000 + CONSYS_DBG_GEN_CONN_INFRA_ON_BUS_APB_TIMEOUT_INFO_2_OFFSET_ADDR,
		CONSYS_REG_READ(CONN_BUS_CR_ON_BASE +
			CONSYS_DBG_GEN_CONN_INFRA_ON_BUS_APB_TIMEOUT_INFO_2_OFFSET_ADDR));

	/* 38 */
	update_debug_read_info_mt6897_debug_gen(pdbg_level_2_info,
		"38", 0x1804c000 + CONSYS_DGEN_INFRA_AXI_LAYER_BUS_BCRM_1804c004_OFFSET,
	...
	/* 39 */
	update_debug_read_info_mt6897_debug_gen(pdbg_level_2_info,
		"39", 0x1804c000 + CONSYS_DGEN_INFRA_AXI_LAYER_BUS_BCRM_1804c00c_OFFSET,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_axi_layer_bus_bcrm_base_mt6897 +
