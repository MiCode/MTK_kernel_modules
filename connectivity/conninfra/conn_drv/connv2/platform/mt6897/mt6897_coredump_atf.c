...
struct consys_platform_coredump_ops g_consys_platform_coredump_ops_mt6897_atf = {
	...
	.consys_coredump_setup_dump_region = consys_plt_coredump_setup_dump_region_mt6897_atf,
	.consys_coredump_setup_dynamic_remap = consys_plt_coredump_setup_dynamic_remap_mt6897_atf,
...
int consys_plt_coredump_setup_dump_region_mt6897_atf(int conn_type)
{
	int ret;
...
unsigned int consys_plt_coredump_setup_dynamic_remap_mt6897_atf(int conn_type, unsigned int idx,
