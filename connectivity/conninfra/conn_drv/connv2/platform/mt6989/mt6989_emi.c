 ...
 */
struct consys_platform_emi_ops g_consys_platform_emi_ops_mt6989 = {
	.consys_ic_emi_mpu_set_region_protection = NULL,
	.consys_ic_emi_set_remapping_reg = consys_emi_set_remapping_reg_mt6989_atf,
	.consys_ic_emi_get_md_shared_emi = NULL,
};

unsigned int consys_emi_set_remapping_reg_mt6989_atf(
