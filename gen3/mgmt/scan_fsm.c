...
VOID scnFsmMsgAbort(IN P_ADAPTER_T prAdapter, IN P_MSG_HDR_T prMsgHdr)
{
	...
	P_SCAN_INFO_T prScanInfo;
	P_SCAN_PARAM_T prScanParam;
	CMD_SCAN_CANCEL rCmdScanCancel = {0};
...
{
	CMD_SET_PSCAN_ADD_HOTLIST_BSSID rCmdPscnAddHotlist = {0};
	P_SCAN_INFO_T prScanInfo;
...
{
	CMD_SET_PSCAN_ADD_SWC_BSSID rCmdPscnAddSWCBssId = {0};
	P_SCAN_INFO_T prScanInfo;
...
{
	CMD_SET_PSCAN_MAC_ADDR rCmdPscnSetMacAddr = {0};
	P_SCAN_INFO_T prScanInfo;
