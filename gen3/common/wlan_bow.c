...
WLAN_STATUS bowCmdDestroyConnection(IN P_ADAPTER_T prAdapter, IN P_AMPC_COMMAND prCmd)
{
	...
	CMD_BT_OVER_WIFI rCmdBtOverWifi = {0};
	P_BOW_FSM_INFO_T prBowFsmInfo;
...
*/
/*----------------------------------------------------------------------------*/
int bowDisconnectLink(IN P_ADAPTER_T prAdapter, IN P_MSDU_INFO_T prMsduInfo, IN ENUM_TX_RESULT_CODE_T rTxDoneStatus)
{
	P_BOW_FSM_INFO_T prBowFsmInfo;
	P_STA_RECORD_T prStaRec;
