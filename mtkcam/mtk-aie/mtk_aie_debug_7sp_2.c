...
void mtk_aie_register_tf_cb_7sp_2(void *data)
{
#ifdef AIE_TF_DUMP_7SP_2
...
EXPORT_SYMBOL(mtk_aie_register_tf_cb_7sp_2);

int mtk_aie_debug_7sp_2_probe(struct platform_device *pdev)
{
    dev_info(&pdev->dev ,"%s+", __func__);
    register_mtk_aie_reg_tf_cb(mtk_aie_register_tf_cb_7sp_2);
    dev_info(&pdev->dev ,"%s-", __func__);

    return 0;
}

int mtk_aie_debug_7sp_2_remove(struct platform_device *pdev)
{
...
static const struct of_device_id of_match_mtk_aie_debug_7sp_2_drv[] = {
	{
...
static struct platform_driver mtk_aie_debug_7sp_2_drv = {
	.probe = mtk_aie_debug_7sp_2_probe,
    .remove = mtk_aie_debug_7sp_2_remove,
	.driver = {
		.name = "mtk-aie-debug-7sp-2",
        .of_match_table = of_match_mtk_aie_debug_7sp_2_drv,
	},
};

module_platform_driver(mtk_aie_debug_7sp_2_drv);
