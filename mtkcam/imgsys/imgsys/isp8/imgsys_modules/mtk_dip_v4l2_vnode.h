...
static const struct mtk_imgsys_video_device_desc dip_setting[] = {
	...
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_SNRGMI_OUT,
		.name = "Snrgmi Input",
		.cap = V4L2_CAP_VIDEO_OUTPUT_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE,
		.smem_alloc = 0,
	...
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_IMG5O_CAPTURE,
		.name = "Img5o Output",
		.cap = V4L2_CAP_VIDEO_CAPTURE_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_CAPTURE_MPLANE,
		.smem_alloc = 0,
		...
		.dma_port = 3,
		.frmsizeenum = &dip_out_frmsizeenum,
		.description = "ink output",
	},
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_IMG6O_CAPTURE,
		.name = "Img6o Output",
		.cap = V4L2_CAP_VIDEO_CAPTURE_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_CAPTURE_MPLANE,
		.smem_alloc = 0,
	...
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_SNRACTO_CAPTURE,
		.name = "Snracto Output",
		.cap = V4L2_CAP_VIDEO_CAPTURE_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_CAPTURE_MPLANE,
		.smem_alloc = 0,
