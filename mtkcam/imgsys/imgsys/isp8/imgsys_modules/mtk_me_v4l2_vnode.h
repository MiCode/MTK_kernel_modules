...
static const struct mtk_imgsys_video_device_desc me_setting[] = {
	...
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_MEL0OSM_OUT,
		.name = "L0OSMI Input",
		.cap = V4L2_CAP_VIDEO_OUTPUT_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE,
		.smem_alloc = 0,
		...
		.dma_port = 0,
		.frmsizeenum = &in_frmsizeenum,
		.description = "ME L0OSM Input ",
	},
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_MEL1OSM_OUT,
		.name = "L1OSMI Input",
		.cap = V4L2_CAP_VIDEO_OUTPUT_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE,
		.smem_alloc = 0,
		...
		.dma_port = 0,
		.frmsizeenum = &in_frmsizeenum,
		.description = "ME L1OSM Input ",
	},
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_MEAPLIMG0_OUT,
		.name = "APLIMG0I Input",
		.cap = V4L2_CAP_VIDEO_OUTPUT_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE,
		.smem_alloc = 0,
		...
		.dma_port = 0,
		.frmsizeenum = &in_frmsizeenum,
		.description = "ME APL IMG0 Input ",
	},
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_MEAPLIMG1_OUT,
		.name = "APLIMG1I Input",
		.cap = V4L2_CAP_VIDEO_OUTPUT_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE,
		.smem_alloc = 0,
		...
		.dma_port = 0,
		.frmsizeenum = &in_frmsizeenum,
		.description = "ME APL IMG1 Input ",
	},
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_MEGYROMV_OUT,
		.name = "MEGYROI Input",
		.cap = V4L2_CAP_VIDEO_OUTPUT_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE,
		.smem_alloc = 0,
	...
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_MEL0BKI_CAPTURE,
		.name = "L0BKIO Output",
		.cap = V4L2_CAP_VIDEO_CAPTURE_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_CAPTURE_MPLANE,
		.smem_alloc = 0,
		...
		.dma_port = 0,
		.frmsizeenum = &out_frmsizeenum,
		.description = "ME L0BKI Output ",
	},
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_MEL1BKI_CAPTURE,
		.name = "L1BKIO Output",
		.cap = V4L2_CAP_VIDEO_CAPTURE_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_CAPTURE_MPLANE,
		.smem_alloc = 0,
		...
		.dma_port = 0,
		.frmsizeenum = &out_frmsizeenum,
		.description = "ME L1BKI Output ",
	},
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_MEGLBMAP_CAPTURE,
		.name = "GLBMAPO Output",
		.cap = V4L2_CAP_VIDEO_CAPTURE_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_CAPTURE_MPLANE,
		.smem_alloc = 0,
		...
		.dma_port = 0,
		.frmsizeenum = &out_frmsizeenum,
		.description = "ME GLBMAP Output ",
	},
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_MEFGMAP_CAPTURE,
		.name = "FGMMAPO Output",
		.cap = V4L2_CAP_VIDEO_CAPTURE_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_CAPTURE_MPLANE,
		.smem_alloc = 0,
