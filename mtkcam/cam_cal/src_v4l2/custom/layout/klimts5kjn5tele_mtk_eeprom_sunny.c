...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0xFF4C0682, CAM_CAL_SINGLE_EEPROM_DATA,
	{
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT klimts5kjn5tele_mtk_eeprom_sunny = {
	.name = "klimts5kjn5tele_mtk_eeprom_sunny",
