...
unsigned int xiaomi_do_single_lsc_kleesc821cs_sunny(struct EEPROM_DRV_FD_DATA *pdata,
...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x000082A4, 0x00000088, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x00008AD3, 0x0000074C, xiaomi_do_single_lsc_kleesc821cs_sunny},
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT kleesc821csultra_mtk_eeprom_sunny = {
	.name = "kleesc821csultra_mtk_eeprom_sunny",
