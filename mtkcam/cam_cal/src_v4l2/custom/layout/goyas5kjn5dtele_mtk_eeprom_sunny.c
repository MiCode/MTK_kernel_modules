...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0xFF510838, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x000016C1, 0x00000A28, xiaomi_do_pdaf},
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT goyas5kjn5dtele_mtk_eeprom_sunny = {
	.name = "goyas5kjn5dtele_mtk_eeprom_sunny",
