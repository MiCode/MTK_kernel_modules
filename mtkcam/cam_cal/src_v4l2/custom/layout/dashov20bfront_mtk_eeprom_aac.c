...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0xFFFFFF94, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000000, 0x00000000, 0x00001FA3, xiaomi_do_dump_all},
		{0x00000000, 0x00000F80, 0x0000000A, NULL}
	}
};

struct STRUCT_CAM_CAL_CONFIG_STRUCT dashov20bfront_mtk_eeprom_aac = {
	.name = "dashov20bfront_mtk_eeprom_aac",
