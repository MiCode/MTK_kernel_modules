...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0xFFFFFF4C, CAM_CAL_SINGLE_EEPROM_DATA,
	{
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT rodinsc820csultra_mtk_eeprom_sunny = {
	.name = "rodinsc820csultra_mtk_eeprom_sunny",
