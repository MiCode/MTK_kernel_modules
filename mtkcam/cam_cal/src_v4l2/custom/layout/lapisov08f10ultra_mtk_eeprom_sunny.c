...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0x00000088, CAM_CAL_SINGLE_EEPROM_DATA,
	{
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT lapisov08f10ultra_mtk_eeprom_sunny = {
	.name = "lapisov08f10ultra_mtk_eeprom_sunny",
