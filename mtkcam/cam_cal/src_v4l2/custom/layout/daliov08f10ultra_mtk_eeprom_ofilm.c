...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x0000020C, 0x00000063, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		{0x00000001, 0x00000205, 0x0000000F, xiaomi_do_module_version},
		{0x00000001, 0x00000214, 0x00000010, xiaomi_do_part_number},
		{0x00000001, 0x00000990, 0x0000074C, xiaomi_do_single_lsc},
		{0x00000001, 0x00000958, 0x00000010, xiaomi_do_2a_gain},
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT daliov08f10ultra_mtk_eeprom_ofilm = {
	.name = "daliov08f10ultra_mtk_eeprom_ofilm",
	.check_layout_function = layout_check,
	.read_function = DALI_OV08F_OTP_read_region,
