...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0xFF60FE62, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x00001842, 0x00000A28, xiaomi_do_pdaf},
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT daliovx8000wide_mtk_eeprom_aac = {
	.name = "daliovx8000wide_mtk_eeprom_aac",
