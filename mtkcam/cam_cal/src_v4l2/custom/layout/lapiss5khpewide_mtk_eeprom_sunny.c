...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0xFF721885, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x000016C1, 0x000005DC, xiaomi_do_pdaf},
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT lapiss5khpewide_mtk_eeprom_sunny = {
	.name = "lapiss5khpewide_mtk_eeprom_sunny",
