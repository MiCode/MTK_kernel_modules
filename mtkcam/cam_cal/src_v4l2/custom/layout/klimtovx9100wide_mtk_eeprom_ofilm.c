...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0xFF4C0364, CAM_CAL_SINGLE_EEPROM_DATA,
	{
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT klimtovx9100wide_mtk_eeprom_ofilm = {
	.name = "klimtovx9100wide_mtk_eeprom_ofilm",
