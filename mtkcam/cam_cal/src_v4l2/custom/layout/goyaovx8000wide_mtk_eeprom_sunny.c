...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0xFF600756, CAM_CAL_SINGLE_EEPROM_DATA,
	{
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT goyaovx8000wide_mtk_eeprom_sunny = {
	.name = "goyaovx8000wide_mtk_eeprom_sunny",
