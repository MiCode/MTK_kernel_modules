...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0xFF692684, CAM_CAL_SINGLE_EEPROM_DATA,
	{
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT lapisimx882wide_mtk_eeprom_ofilm = {
	.name = "lapisimx882wide_mtk_eeprom_ofilm",
