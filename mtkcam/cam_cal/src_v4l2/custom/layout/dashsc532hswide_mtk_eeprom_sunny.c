...
unsigned int dashsc532hswide_sunny_do_pdaf(struct EEPROM_DRV_FD_DATA *pdata,
...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0xFF8048A4, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x000012D6, 0x00000A28, dashsc532hswide_sunny_do_pdaf},
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT dashsc532hswide_mtk_eeprom_sunny = {
	.name = "dashsc532hswide_mtk_eeprom_sunny",
