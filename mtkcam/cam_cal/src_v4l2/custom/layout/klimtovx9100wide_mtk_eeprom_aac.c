...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0xFF620464, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x00001848, 0x00000A28, xiaomi_do_pdaf},
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT klimtovx9100wide_mtk_eeprom_aac = {
	.name = "klimtovx9100wide_mtk_eeprom_aac",
