...
unsigned int xiaomi_do_single_lsc_dashsc821cs_aac(struct EEPROM_DRV_FD_DATA *pdata,
...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x000082A4, 0x00000087, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x00008AD3, 0x0000074C, xiaomi_do_single_lsc_dashsc821cs_aac},
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT dashsc821csultra_mtk_eeprom_aac = {
	.name = "dashsc821csultra_mtk_eeprom_aac",
