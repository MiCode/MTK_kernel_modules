...
struct subdrv_mode_struct {
	...
	u16 *mode_second_setting_table;
	u32 mode_second_setting_len;
	u16 *seamless_switch_mode_second_setting_table;
	u32 seamless_switch_mode_second_setting_len;
#endif
...
#ifdef __XIAOMI_CAMERA__
	void (*set_mirror_flip)(void *arg, u8 image_mirror);
