 ...
 * Filename:
 * ---------
 *     LAPISOV20BFRONTmipiraw_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
 ...
 *============================================================================
 ****************************************************************************/
#include "lapisov20bfrontmipiraw_Sensor.h"


#define DEBUG_LOG_EN 0
#define PFX "LAPISOV20BFRONT_camera_sensor"
...
static int lapisov20bfront_set_test_pattern(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static void lapisov20bfront_set_mirror_flip(void *arg, u8 image_mirror);
...
static struct subdrv_feature_control feature_control_list[] = {
	{
		...
		.func = lapisov20bfront_set_test_pattern
	},
};
...
static struct subdrv_mode_struct mode_struct[] = {
	{	/* mode 0 : preview 2592x1944@30fps */
		.mode_setting_table = lapisov20bfront_preview_setting,
		.mode_setting_len = ARRAY_SIZE(lapisov20bfront_preview_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 50000000,
	...
	{	/* mode 2 : normal video 2560x1440@30fps */
		.mode_setting_table = lapisov20bfront_normal_video_setting,
		.mode_setting_len = ARRAY_SIZE(lapisov20bfront_normal_video_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 50013889,
	...
	{	/* mode : 3 hs_video 720p@120fps */
		.mode_setting_table = lapisov20bfront_hs_video_setting,
		.mode_setting_len = ARRAY_SIZE(lapisov20bfront_hs_video_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 50013889,
	...
	{	/* mode 5 : video 60fps 2560x1440@60FPS */
		.mode_setting_table = lapisov20bfront_custom1_setting,
		.mode_setting_len = ARRAY_SIZE(lapisov20bfront_custom1_setting),
	...
	{	/* mode : 6  640x480@10FPS */
		.mode_setting_table = lapisov20bfront_custom2_setting,
		.mode_setting_len = ARRAY_SIZE(lapisov20bfront_custom2_setting),
		.mode_setting_table_for_md = lapisov20bfront_md1_setting,
		.mode_setting_len_for_md = ARRAY_SIZE(lapisov20bfront_md1_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 50000000,
	...
	{	/* mode : 7  640x480@20FPS */
		.mode_setting_table = lapisov20bfront_custom3_setting,
		.mode_setting_len = ARRAY_SIZE(lapisov20bfront_custom3_setting),
		.mode_setting_table_for_md = lapisov20bfront_md1_setting,
		.mode_setting_len_for_md = ARRAY_SIZE(lapisov20bfront_md1_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
	...
	{	/* mode : 8  640x480@30FPS */
		.mode_setting_table = lapisov20bfront_custom4_setting,
		.mode_setting_len = ARRAY_SIZE(lapisov20bfront_custom4_setting),
		.mode_setting_table_for_md = lapisov20bfront_md1_setting,
		.mode_setting_len_for_md = ARRAY_SIZE(lapisov20bfront_md1_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
...
static struct subdrv_static_ctx static_ctx = {
	.sensor_id = LAPISOV20BFRONT_SENSOR_ID,
	...
	.ana_gain_type = 1,
	.ana_gain_step = 64,
	.ana_gain_table = lapisov20bfront_ana_gain_table,
	.ana_gain_table_size = sizeof(lapisov20bfront_ana_gain_table),
	.min_gain_iso = 50,
	.exposure_def = 0x3D0,
	.exposure_min = 2,
	...
	.init_setting_table = lapisov20bfront_init_setting,
	.init_setting_len = ARRAY_SIZE(lapisov20bfront_init_setting),
	.mode = mode_struct,
	...
	.set_mirror_flip = lapisov20bfront_set_mirror_flip,
};
...
const struct subdrv_entry lapisov20bfront_mipi_raw_entry = {
	.name = "lapisov20bfront_mipi_raw",
	.id = LAPISOV20BFRONT_SENSOR_ID,
	.pw_seq = pw_seq,
...
static void lapisov20bfront_set_mirror_flip(void *arg, u8 image_mirror){
	...
	vflip = subdrv_i2c_rd_u8(ctx, 0x3820);
	mirror = subdrv_i2c_rd_u8(ctx, 0x3821);
	switch (image_mirror) {
	//normal: flip:0 mirror:1
	//h_mirror: flip:0 mirror:0
	//v_flip: flip:1 mirror:1
	//mirror+flip: flip:1 mirror:0
	case IMAGE_NORMAL:
		vflip &= 0xFB;
		mirror |= 0x04;
		break;
	...
	subdrv_i2c_wr_u8(ctx, 0x3820, vflip);
	subdrv_i2c_wr_u8(ctx, 0x3821, mirror);
}