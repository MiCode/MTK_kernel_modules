 ...
 *============================================================================
 ****************************************************************************/
#include "imx966mipiraw_Sensor.h"

static void set_sensor_cali(void *arg);
static int get_sensor_temperature(void *arg);
static void set_group_hold(void *arg, u8 en);
static u16 get_gain2reg(u32 gain);
static int imx966_seamless_switch(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int imx966_set_test_pattern(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int imx966_set_test_pattern_data(struct subdrv_ctx *ctx, u8 *para, u32 *len);
...
static struct subdrv_feature_control feature_control_list[] = {
	{SENSOR_FEATURE_SET_TEST_PATTERN, imx966_set_test_pattern},
	{SENSOR_FEATURE_SET_TEST_PATTERN_DATA, imx966_set_test_pattern_data},
	{SENSOR_FEATURE_SEAMLESS_SWITCH, imx966_seamless_switch},
};

static struct eeprom_info_struct eeprom_info[] = {
	{
		.header_id = 0x015E012C,
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info_fullsize = {
	...
	.i4Crop = {
		...
		{0, 768}, {0, 768}, {0, 0}, {0, 0}, {0, 0}, {2048, 1536},
	    /* <cust6> <cust7> <cust8> <cust9> <cust10>*/
		{0, 384}, {2048, 1536}, {0, 0}, {0, 0}, {0, 384},
...
static struct SET_PD_BLOCK_INFO_T imgsensor_partial_pd_info = {
	...
	/* VC's PD pattern description */
	.sPDMapInfo[0] = {
		.i4VCFeature = VC_PDAF_STATS_NE_PIX_1,//HCG
		.i4PDPattern = 3,
		.i4PDRepetition = 4,
...
static u32 imx966_dcg_ratio_table_12bit[] = {4000};

static u32 imx966_dcg_ratio_table_14bit[] = {16000};
...
static struct subdrv_mode_struct mode_struct[] = {
	{
		...
		.mode_setting_table = imx966_preview_setting,
		.mode_setting_len = ARRAY_SIZE(imx966_preview_setting),
		.seamless_switch_group = 1,
		.seamless_switch_mode_setting_table = imx966_seamless_preview,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(imx966_seamless_preview),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 2196000000,
	...
	},
	{
		...
		.mode_setting_table = imx966_capture_setting,
		.mode_setting_len = ARRAY_SIZE(imx966_capture_setting),
	...
	},
	{
		...
		.mode_setting_table = imx966_normal_video_setting,
		.mode_setting_len = ARRAY_SIZE(imx966_normal_video_setting),
		.seamless_switch_group = 2,
		.seamless_switch_mode_setting_table = imx966_seamless_normal_video,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(imx966_seamless_normal_video),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 2196000000,
	...
	},
	{
		...
		.mode_setting_table = imx966_hs_video_setting,
		.mode_setting_len = ARRAY_SIZE(imx966_hs_video_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	},
	{
		...
		.mode_setting_table = imx966_slim_video_setting,
		.mode_setting_len = ARRAY_SIZE(imx966_slim_video_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	},
	{
		...
		.mode_setting_table = imx966_custom1_setting,
		.mode_setting_len = ARRAY_SIZE(imx966_custom1_setting),
		.seamless_switch_group = 2,
		.seamless_switch_mode_setting_table = imx966_seamless_custom1,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(imx966_seamless_custom1),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 2196000000,
	...
	},
	{
		...
		.mode_setting_table = imx966_custom2_setting,
		.mode_setting_len = ARRAY_SIZE(imx966_custom2_setting),
		.seamless_switch_group = 2,
		.seamless_switch_mode_setting_table = imx966_seamless_custom2,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(imx966_seamless_custom2),
		...
		.dcg_info = {
			...
			.dcg_gain_table = imx966_dcg_ratio_table_ratio4,
			.dcg_gain_table_size = sizeof(imx966_dcg_ratio_table_ratio4),
		},
	...
	},
	{
		...
		.mode_setting_table = imx966_custom3_setting,
		.mode_setting_len = ARRAY_SIZE(imx966_custom3_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	},
	{
		...
		.mode_setting_table = imx966_custom4_setting,
		.mode_setting_len = ARRAY_SIZE(imx966_custom4_setting),
		.seamless_switch_group = 2,
		.seamless_switch_mode_setting_table = imx966_seamless_custom4,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(imx966_seamless_custom4),
		...
		.dcg_info = {
			...
			.dcg_gain_ratio_max = 4000,
			.dcg_gain_ratio_step = 0,
			.dcg_gain_table = imx966_dcg_ratio_table_12bit,
			.dcg_gain_table_size = sizeof(imx966_dcg_ratio_table_12bit),
		},
		.multi_exposure_ana_gain_range[IMGSENSOR_EXPOSURE_LE].min = BASEGAIN * 4,
		.multi_exposure_ana_gain_range[IMGSENSOR_EXPOSURE_ME].max = BASEGAIN * 16,
		.dpc_enabled = true,
	},
	{
		...
		.mode_setting_table = imx966_custom5_setting,
		.mode_setting_len = ARRAY_SIZE(imx966_custom5_setting),
		.seamless_switch_group = 2,
		.seamless_switch_mode_setting_table = imx966_seamless_custom5,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(imx966_seamless_custom5),
		.hdr_mode = HDR_RAW_DCG_COMPOSE,
		.raw_cnt = 1,
		.exp_cnt = 2,
		.pclk = 3225600000,
		...
		.dcg_info = {
			...
			.dcg_gain_ratio_step = 0,
			.dcg_gain_table = imx966_dcg_ratio_table_14bit,
			.dcg_gain_table_size = sizeof(imx966_dcg_ratio_table_14bit),
		},
	...
	},
	{
		...
		.mode_setting_table = imx966_custom6_setting,
		.mode_setting_len = ARRAY_SIZE(imx966_custom6_setting),
		.seamless_switch_group = 2,
		.seamless_switch_mode_setting_table = imx966_seamless_custom6,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(imx966_seamless_custom6),
	...
	},
	{
		...
		.mode_setting_table = imx966_custom7_setting,
		.mode_setting_len = ARRAY_SIZE(imx966_custom7_setting),
		.seamless_switch_group = 2,
		.seamless_switch_mode_setting_table = imx966_seamless_custom7,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(imx966_seamless_custom7),
	...
	},
	{
		...
		.mode_setting_table = imx966_custom8_setting,
		.mode_setting_len = ARRAY_SIZE(imx966_custom8_setting),
		.seamless_switch_group = 2,
		.seamless_switch_mode_setting_table = imx966_seamless_custom8,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(imx966_seamless_custom8),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 3225600000,
	...
	},
	{
		...
		.mode_setting_table = imx966_custom9_setting,
		.mode_setting_len = ARRAY_SIZE(imx966_custom9_setting),
		.seamless_switch_group = 2,
		.seamless_switch_mode_setting_table = imx966_seamless_custom9,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(imx966_seamless_custom9),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 3225600000,
	...
	},
	{
		...
		.mode_setting_table = imx966_custom10_setting,
		.mode_setting_len = ARRAY_SIZE(imx966_custom10_setting),
		.seamless_switch_group = 1,
		.seamless_switch_mode_setting_table = imx966_seamless_custom10,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(imx966_seamless_custom10),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 4070400000,
	...
	},
	{
		...
		.mode_setting_table = imx966_custom11_setting,
		.mode_setting_len = ARRAY_SIZE(imx966_custom11_setting),
		.seamless_switch_group = 1,
		.seamless_switch_mode_setting_table = imx966_seamless_custom11,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(imx966_seamless_custom11),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 4070400000,
	...
	},
	{
		...
		.mode_setting_table = imx966_custom12_setting,
		.mode_setting_len = ARRAY_SIZE(imx966_custom12_setting),
		.seamless_switch_group = 1,
		.seamless_switch_mode_setting_table = imx966_seamless_custom12,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(imx966_seamless_custom12),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 4070400000,
	...
	},
	{
		...
		.mode_setting_table = imx966_custom13_setting,
		.mode_setting_len = ARRAY_SIZE(imx966_custom13_setting),
		.seamless_switch_group = 1,
		.seamless_switch_mode_setting_table = imx966_seamless_custom13,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(imx966_seamless_custom13),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 4070400000,
	...
	},
	{
		...
		.mode_setting_table = imx966_custom14_setting,
		.mode_setting_len = ARRAY_SIZE(imx966_custom14_setting),
		.seamless_switch_group = 1,
		.seamless_switch_mode_setting_table = imx966_seamless_custom14,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(imx966_seamless_custom14),
		.hdr_mode = HDR_RAW_STAGGER,
		.raw_cnt = 2,
		.exp_cnt = 2,
		.pclk = 4070400000,
	...
	},
	{
		...
		.mode_setting_table = imx966_custom15_setting,
		.mode_setting_len = ARRAY_SIZE(imx966_custom15_setting),
		.seamless_switch_group = 1,
		.seamless_switch_mode_setting_table = imx966_seamless_custom15,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(imx966_seamless_custom15),
		.hdr_mode = HDR_RAW_STAGGER,
		.raw_cnt = 3,
		.exp_cnt = 3,
		.pclk = 4070400000,
	...
	},
	{
		...
		.mode_setting_table = imx966_custom16_setting,
		.mode_setting_len = ARRAY_SIZE(imx966_custom16_setting),
		.seamless_switch_group = 1,
		.seamless_switch_mode_setting_table = imx966_seamless_custom16,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(imx966_seamless_custom16),
		.hdr_mode = HDR_RAW_DCG_COMPOSE,
		.raw_cnt = 1,
		.exp_cnt = 2,
		.pclk = 4070400000,
	...
	},
	{
		...
		.mode_setting_table = imx966_custom17_setting,
		.mode_setting_len = ARRAY_SIZE(imx966_custom17_setting),
		.seamless_switch_group = 1,
		.seamless_switch_mode_setting_table = imx966_seamless_custom17,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(imx966_seamless_custom17),
		.hdr_mode = HDR_RAW_DCG_COMPOSE,
		.raw_cnt = 1,
		.exp_cnt = 2,
		.pclk = 4070400000,
	...
	},
	{
		...
		.mode_setting_table = imx966_custom18_setting,
		.mode_setting_len = ARRAY_SIZE(imx966_custom18_setting),
		.seamless_switch_group = 1,
		.seamless_switch_mode_setting_table = imx966_seamless_custom18,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(imx966_seamless_custom18),
		.hdr_mode = HDR_RAW_LBMF,
		.raw_cnt = 2,
		.exp_cnt = 2,
		.pclk = 4070400000,
	...
	},
	{
		...
		.mode_setting_table = imx966_custom19_setting,
		.mode_setting_len = ARRAY_SIZE(imx966_custom19_setting),
		.seamless_switch_group = 1,
		.seamless_switch_mode_setting_table = imx966_seamless_custom19,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(imx966_seamless_custom19),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 4070400000,
	...
	},
	{
		...
		.mode_setting_table = imx966_custom20_setting,
		.mode_setting_len = ARRAY_SIZE(imx966_custom20_setting),
		.seamless_switch_group = 1,
		.seamless_switch_mode_setting_table = imx966_seamless_custom20,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(imx966_seamless_custom20),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 4339200000,
	...
	},
	{
		...
		.mode_setting_table = imx966_custom21_setting,
		.mode_setting_len = ARRAY_SIZE(imx966_custom21_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	},
	{
		...
		.mode_setting_table = imx966_custom22_setting,
		.mode_setting_len = ARRAY_SIZE(imx966_custom22_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	},
	{
		...
		.mode_setting_table = imx966_custom23_setting,
		.mode_setting_len = ARRAY_SIZE(imx966_custom23_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
		...
		.mode_setting_table = imx966_custom24_setting,
		.mode_setting_len = ARRAY_SIZE(imx966_custom24_setting),
		.seamless_switch_group = 2,
		.seamless_switch_mode_setting_table = imx966_seamless_custom24,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(imx966_seamless_custom24),
		.hdr_mode = HDR_RAW_DCG_RAW,
		.raw_cnt = 2,
		.exp_cnt = 2,
		.pclk = 3225600000,
	...
	},
	{
		...
		.mode_setting_table = imx966_custom25_setting,
		.mode_setting_len = ARRAY_SIZE(imx966_custom25_setting),
		.seamless_switch_group = 1,
		.seamless_switch_mode_setting_table = imx966_seamless_custom25,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(imx966_seamless_custom25),
		.hdr_mode = HDR_RAW_DCG_RAW,
		.raw_cnt = 2,
		.exp_cnt = 2,
		.pclk = 4070400000,
	...
	},
	{
		...
		.mode_setting_table = imx966_custom26_setting,
		.mode_setting_len = ARRAY_SIZE(imx966_custom26_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_RAW_DCG_RAW,
...
static struct subdrv_static_ctx static_ctx = {
	...
	.ana_gain_type = 0,
	.ana_gain_step = 1,
	.ana_gain_table = imx966_ana_gain_table,
	.ana_gain_table_size = sizeof(imx966_ana_gain_table),
	.min_gain_iso = 100,
	.exposure_def = 0x3D0,
	.exposure_min = 8,
	...
	.init_setting_table = imx966_init_setting,
	.init_setting_len = ARRAY_SIZE(imx966_init_setting),
	.mode = mode_struct,
...
const struct subdrv_entry imx966_mipi_raw_entry = {
	.name = "imx966_mipi_raw",
	.id = IMX966_SENSOR_ID,
	.pw_seq = pw_seq,
