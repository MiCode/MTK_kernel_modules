 ...
 * Filename:
 * ---------
 *     DASHOV20BFRONTmipiraw_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
 ...
 *============================================================================
 ****************************************************************************/
#include "dashov20bfrontmipiraw_Sensor.h"


#define DEBUG_LOG_EN 0
#define PFX "DASHOV20BFRONT_camera_sensor"
...
static int dashov20bfront_get_imgsensor_id(struct subdrv_ctx *ctx, u32 *sensor_id);
...
static int dashov20bfront_set_test_pattern(struct subdrv_ctx *ctx, u8 *para, u32 *len);
...
static struct subdrv_feature_control feature_control_list[] = {
	{
		...
		.func = dashov20bfront_set_test_pattern
	},
};
...
static struct subdrv_mode_struct mode_struct[] = {
	{	/* mode 0 : preview 2592x1944@30fps */
		.mode_setting_table = dashov20bfront_preview_setting,
		.mode_setting_len = ARRAY_SIZE(dashov20bfront_preview_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 50000000,
	...
	{	/* mode 2 : normal video 2560x1440@30fps */
		.mode_setting_table = dashov20bfront_normal_video_setting,
		.mode_setting_len = ARRAY_SIZE(dashov20bfront_normal_video_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 50000000,
	...
	{	/* mode : 3 hs_video 720p@120fps */
		.mode_setting_table = dashov20bfront_hs_video_setting,
		.mode_setting_len = ARRAY_SIZE(dashov20bfront_hs_video_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 50000000,
	...
	{	/* mode 5 : video 60fps 2560x1440@60FPS */
		.mode_setting_table = dashov20bfront_custom1_setting,
		.mode_setting_len = ARRAY_SIZE(dashov20bfront_custom1_setting),
	...
	{	/* mode : 6  640x480@10FPS */
		.mode_setting_table = dashov20bfront_custom2_setting,
		.mode_setting_len = ARRAY_SIZE(dashov20bfront_custom2_setting),
		.mode_setting_table_for_md = dashov20bfront_md1_setting,
		.mode_setting_len_for_md = ARRAY_SIZE(dashov20bfront_md1_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 50000000,
	...
	{	/* mode : 7  640x480@20FPS */
		.mode_setting_table = dashov20bfront_custom3_setting,
		.mode_setting_len = ARRAY_SIZE(dashov20bfront_custom3_setting),
		.mode_setting_table_for_md = dashov20bfront_md1_setting,
		.mode_setting_len_for_md = ARRAY_SIZE(dashov20bfront_md1_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
	...
	{	/* mode : 8  640x480@30FPS */
		.mode_setting_table = dashov20bfront_custom4_setting,
		.mode_setting_len = ARRAY_SIZE(dashov20bfront_custom4_setting),
		.mode_setting_table_for_md = dashov20bfront_md1_setting,
		.mode_setting_len_for_md = ARRAY_SIZE(dashov20bfront_md1_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
...
static struct subdrv_static_ctx static_ctx = {
	.sensor_id = DASHOV20BFRONT_SENSOR_ID,
	...
	.ana_gain_type = 1,
	.ana_gain_step = 64,
	.ana_gain_table = dashov20bfront_ana_gain_table,
	.ana_gain_table_size = sizeof(dashov20bfront_ana_gain_table),
	.tuning_iso_base = 50,
	.exposure_def = 0x3D0,
	.exposure_min = 2,
	...
	.init_setting_table = dashov20bfront_init_setting,
	.init_setting_len = ARRAY_SIZE(dashov20bfront_init_setting),
	.mode = mode_struct,
...
static struct subdrv_ops ops = {
	.init_ctx = init_ctx,
	.open = common_open,
	.get_id = dashov20bfront_get_imgsensor_id,
...
const struct subdrv_entry dashov20bfront_mipi_raw_entry = {
	.name = "dashov20bfront_mipi_raw",
	.id = DASHOV20BFRONT_SENSOR_ID,
	.pw_seq = pw_seq,
...
int dashov20bfront_get_imgsensor_id(struct subdrv_ctx *ctx, u32 *sensor_id)
{
	u8 i = 0;
	u8 retry = 2;
