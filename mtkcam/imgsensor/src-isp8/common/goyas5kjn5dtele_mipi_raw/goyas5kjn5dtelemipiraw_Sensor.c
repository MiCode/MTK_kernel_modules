...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info = {
	...
	.i4Crop = {
		...
		{128, 456}, {0, 384}, {0, 0}, {0, 0}, {2048, 1536},
...
static struct subdrv_mode_struct mode_struct[] = {
	...
	//30fps --> 60fps
	//complete 12 v1.6ze_0610
	{
		.frame_desc = frame_desc_cus1,
		.num_entries = ARRAY_SIZE(frame_desc_cus1),
		.mode_setting_table = goyas5kjn5dtele_custom1_setting,
		.mode_setting_len = ARRAY_SIZE(goyas5kjn5dtele_custom1_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
...
void goyas5kjn5dtele_write_lens(struct subdrv_ctx *ctx)
{
	u16 len_macro = 0;
	u16 len_inf = 0;
	u8 *pbuf = NULL;
...
static int goyas5kjn5dtele_seamless_switch(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	...
	if(ctx->s_ctx.mode[scenario_id].imgsensor_winsize_info.w2_tg_size == 8192)
		goyas5kjn5dtele_write_lens(ctx);
