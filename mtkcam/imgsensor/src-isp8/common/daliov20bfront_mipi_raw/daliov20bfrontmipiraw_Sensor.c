 ...
 * Filename:
 * ---------
 *     DALIOV20BFRONTmipiraw_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
 ...
 *============================================================================
 ****************************************************************************/
#include "daliov20bfrontmipiraw_Sensor.h"


#define DEBUG_LOG_EN 0
#define PFX "DALIOV20BFRONT_camera_sensor"
...
static int daliov20bfront_get_imgsensor_id(struct subdrv_ctx *ctx, u32 *sensor_id);
...
static int daliov20bfront_set_test_pattern(struct subdrv_ctx *ctx, u8 *para, u32 *len);
...
static struct subdrv_feature_control feature_control_list[] = {
	{
		...
		.func = daliov20bfront_set_test_pattern
	},
};
...
static struct subdrv_mode_struct mode_struct[] = {
	...
	{
		.mode_setting_table = daliov20bfront_preview_setting,
		.mode_setting_len = ARRAY_SIZE(daliov20bfront_preview_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 50000000,
	...
	{
		.mode_setting_table = daliov20bfront_normal_video_setting,
		.mode_setting_len = ARRAY_SIZE(daliov20bfront_normal_video_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 50000000,
	...
	{
		.mode_setting_table = daliov20bfront_hs_video_setting,
		.mode_setting_len = ARRAY_SIZE(daliov20bfront_hs_video_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 50000000,
	...
	{
		.mode_setting_table = daliov20bfront_custom1_setting,
		.mode_setting_len = ARRAY_SIZE(daliov20bfront_custom1_setting),
	...
	{
		.mode_setting_table = daliov20bfront_custom2_setting,
		.mode_setting_len = ARRAY_SIZE(daliov20bfront_custom2_setting),
		.mode_setting_table_for_md = daliov20bfront_md1_setting,
		.mode_setting_len_for_md = ARRAY_SIZE(daliov20bfront_md1_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 50000000,
	...
	{
		.mode_setting_table = daliov20bfront_custom3_setting,
		.mode_setting_len = ARRAY_SIZE(daliov20bfront_custom3_setting),
		.mode_setting_table_for_md = daliov20bfront_md1_setting,
		.mode_setting_len_for_md = ARRAY_SIZE(daliov20bfront_md1_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
	...
	{	/* mode : 8  640x480@30FPS */
		.mode_setting_table = daliov20bfront_custom4_setting,
		.mode_setting_len = ARRAY_SIZE(daliov20bfront_custom4_setting),
		.mode_setting_table_for_md = daliov20bfront_md1_setting,
		.mode_setting_len_for_md = ARRAY_SIZE(daliov20bfront_md1_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
...
static struct subdrv_static_ctx static_ctx = {
	.sensor_id = DALIOV20BFRONT_SENSOR_ID,
	...
	.ana_gain_type = 1,
	.ana_gain_step = 64,
	.ana_gain_table = daliov20bfront_ana_gain_table,
	.ana_gain_table_size = sizeof(daliov20bfront_ana_gain_table),
	.tuning_iso_base = 50,
	.exposure_def = 0x3D0,
	.exposure_min = 2,
	...
	.init_setting_table = daliov20bfront_init_setting,
	.init_setting_len = ARRAY_SIZE(daliov20bfront_init_setting),
	.mode = mode_struct,
...
static struct subdrv_ops ops = {
	.init_ctx = init_ctx,
	.open = common_open,
	.get_id = daliov20bfront_get_imgsensor_id,
...
const struct subdrv_entry daliov20bfront_mipi_raw_entry = {
	.name = "daliov20bfront_mipi_raw",
	.id = DALIOV20BFRONT_SENSOR_ID,
	.pw_seq = pw_seq,
	.pw_seq_cnt = ARRAY_SIZE(pw_seq),
	.ops = &ops,
};

int daliov20bfront_get_imgsensor_id(struct subdrv_ctx *ctx, u32 *sensor_id)
{
	u8 i = 0;
	u8 retry = 2;
