...
int add_external_subdrv_entry_spm_isp8(struct subdrv_entry *target)
{
...
EXPORT_SYMBOL(add_external_subdrv_entry_spm_isp8);

struct external_entry *query_external_subdrv_entry_spm_isp8(const char *name)
{
	struct external_entry *entry = NULL;
...
EXPORT_SYMBOL(query_external_subdrv_entry_spm_isp8);
