...
struct seninf_ctx {
	...
	unsigned int bypass_record_cammux_info_flag;
...
#define USED_CAMMUX_MAX_MUM 15
#define USED_CSI_MAX_MUM 4
#define USED_MUX_MAX_MUM 10
#define USED_SENINF_MUM 8
struct mtk_cam_seninf_vsync_info {
	...
	u64 time_mono;
	unsigned int used_mux_num;
	unsigned int used_mux[USED_MUX_MAX_MUM];
	unsigned int used_seninf[USED_SENINF_MUM];
	unsigned int seninf_irq_st[USED_SENINF_MUM];
	unsigned int used_seninf_num;
};
