...
#define RG_CS_AFIFO_BISTA_RST_B_SHIFT 0
#define RG_CS_AFIFO_BISTA_RST_B_MASK (0x3f << 0)
#define RG_CS_AFIFO_BISTB_RST_B_SHIFT 8
#define RG_CS_AFIFO_BISTB_RST_B_MASK (0x3f << 8)

#define SENINF_TOP_AFIFOBIST_CTRL1 0x0094
#define RG_CSI_AFIFO_BISTA_EN_SHIFT 0
#define RG_CSI_AFIFO_BISTA_EN_MASK (0x3f << 0)
#define RG_CSI_AFIFO_BISTB_EN_SHIFT 8
#define RG_CSI_AFIFO_BISTB_EN_MASK (0x3f << 8)

#define SENINF_TOP_AFIFOBIST_CTRL2 0x0098
#define RG_CSI_AFIFO_BISTA_MODE_SHIFT 0
#define RG_CSI_AFIFO_BISTA_MODE_MASK (0x3f << 0)
#define RG_CSI_AFIFO_BISTB_MODE_SHIFT 8
#define RG_CSI_AFIFO_BISTB_MODE_MASK (0x3f << 8)

#define SENINF_TOP_AFIFOBIST_SETTING 0x009c
#define RG_CSI_AFIFO_BIST_WRT_LENGTH_SHIFT 0
#define RG_CSI_AFIFO_BIST_WRT_LENGTH_MASK (0xf << 0)
#define RG_CSI_AFIFO_BIST_STP_LENGTH_SHIFT 4
#define RG_CSI_AFIFO_BIST_STP_LENGTH_MASK (0xf << 4)
#define RG_CSI_AFIFO_BIST_SEED_SEL_SHIFT 8
#define RG_CSI_AFIFO_BIST_SEED_SEL_MASK (0x1 << 8)
#define RG_CSI_AFIFO_BIST_LENGTH_SHIFT 16
#define RG_CSI_AFIFO_BIST_LENGTH_MASK (0xffff << 16)

#define SENINF_TOP_AFIFOBIST_STATUS0 0x00a0
#define RO_CSI_ISP_AFIFO_BIST0A_DONE_SHIFT 0
#define RO_CSI_ISP_AFIFO_BIST0A_DONE_MASK (0x1 << 0)
#define RO_CSI_ISP_AFIFO_BIST0A_PASS_SHIFT 1
#define RO_CSI_ISP_AFIFO_BIST0A_PASS_MASK (0x1ff << 1)
#define RO_CSI_ISP_AFIFO_BIST0A_FAIL_SHIFT 10
#define RO_CSI_ISP_AFIFO_BIST0A_FAIL_MASK (0x1ff << 10)
#define RO_CSI_ISP_AFIFO_BIST0B_DONE_SHIFT 20
#define RO_CSI_ISP_AFIFO_BIST0B_DONE_MASK (0x1 << 20)
#define RO_CSI_ISP_AFIFO_BIST0B_PASS_SHIFT 21
#define RO_CSI_ISP_AFIFO_BIST0B_PASS_MASK (0x1f << 21)
#define RO_CSI_ISP_AFIFO_BIST0B_FAIL_SHIFT 26
#define RO_CSI_ISP_AFIFO_BIST0B_FAIL_MASK (0x1f << 26)

#define SENINF_TOP_AFIFOBIST_STATUS1 0x00a4
#define RO_CSI_ISP_AFIFO_BIST1A_DONE_SHIFT 0
#define RO_CSI_ISP_AFIFO_BIST1A_DONE_MASK (0x1 << 0)
#define RO_CSI_ISP_AFIFO_BIST1A_PASS_SHIFT 1
#define RO_CSI_ISP_AFIFO_BIST1A_PASS_MASK (0x1ff << 1)
#define RO_CSI_ISP_AFIFO_BIST1A_FAIL_SHIFT 10
#define RO_CSI_ISP_AFIFO_BIST1A_FAIL_MASK (0x1ff << 10)
#define RO_CSI_ISP_AFIFO_BIST1B_DONE_SHIFT 20
#define RO_CSI_ISP_AFIFO_BIST1B_DONE_MASK (0x1 << 20)
#define RO_CSI_ISP_AFIFO_BIST1B_PASS_SHIFT 21
#define RO_CSI_ISP_AFIFO_BIST1B_PASS_MASK (0x1f << 21)
#define RO_CSI_ISP_AFIFO_BIST1B_FAIL_SHIFT 26
#define RO_CSI_ISP_AFIFO_BIST1B_FAIL_MASK (0x1f << 26)

#define SENINF_TOP_AFIFOBIST_STATUS2 0x00a8
#define RO_CSI_ISP_AFIFO_BIST2A_DONE_SHIFT 0
#define RO_CSI_ISP_AFIFO_BIST2A_DONE_MASK (0x1 << 0)
#define RO_CSI_ISP_AFIFO_BIST2A_PASS_SHIFT 1
#define RO_CSI_ISP_AFIFO_BIST2A_PASS_MASK (0x1ff << 1)
#define RO_CSI_ISP_AFIFO_BIST2A_FAIL_SHIFT 10
#define RO_CSI_ISP_AFIFO_BIST2A_FAIL_MASK (0x1ff << 10)
#define RO_CSI_ISP_AFIFO_BIST2B_DONE_SHIFT 20
#define RO_CSI_ISP_AFIFO_BIST2B_DONE_MASK (0x1 << 20)
#define RO_CSI_ISP_AFIFO_BIST2B_PASS_SHIFT 21
#define RO_CSI_ISP_AFIFO_BIST2B_PASS_MASK (0x1f << 21)
#define RO_CSI_ISP_AFIFO_BIST2B_FAIL_SHIFT 26
#define RO_CSI_ISP_AFIFO_BIST2B_FAIL_MASK (0x1f << 26)

#define SENINF_TOP_AFIFOBIST_STATUS3 0x00ac
#define RO_CSI_ISP_AFIFO_BIST3A_DONE_SHIFT 0
#define RO_CSI_ISP_AFIFO_BIST3A_DONE_MASK (0x1 << 0)
#define RO_CSI_ISP_AFIFO_BIST3A_PASS_SHIFT 1
#define RO_CSI_ISP_AFIFO_BIST3A_PASS_MASK (0x1ff << 1)
#define RO_CSI_ISP_AFIFO_BIST3A_FAIL_SHIFT 10
#define RO_CSI_ISP_AFIFO_BIST3A_FAIL_MASK (0x1ff << 10)
#define RO_CSI_ISP_AFIFO_BIST3B_DONE_SHIFT 20
#define RO_CSI_ISP_AFIFO_BIST3B_DONE_MASK (0x1 << 20)
#define RO_CSI_ISP_AFIFO_BIST3B_PASS_SHIFT 21
#define RO_CSI_ISP_AFIFO_BIST3B_PASS_MASK (0x1f << 21)
#define RO_CSI_ISP_AFIFO_BIST3B_FAIL_SHIFT 26
#define RO_CSI_ISP_AFIFO_BIST3B_FAIL_MASK (0x1f << 26)

#define SENINF_TOP_AFIFOBIST_STATUS4 0x00b0
#define RO_CSI_ISP_AFIFO_BIST4A_DONE_SHIFT 0
#define RO_CSI_ISP_AFIFO_BIST4A_DONE_MASK (0x1 << 0)
#define RO_CSI_ISP_AFIFO_BIST4A_PASS_SHIFT 1
#define RO_CSI_ISP_AFIFO_BIST4A_PASS_MASK (0x1ff << 1)
#define RO_CSI_ISP_AFIFO_BIST4A_FAIL_SHIFT 10
#define RO_CSI_ISP_AFIFO_BIST4A_FAIL_MASK (0x1ff << 10)
#define RO_CSI_ISP_AFIFO_BIST4B_DONE_SHIFT 20
#define RO_CSI_ISP_AFIFO_BIST4B_DONE_MASK (0x1 << 20)
#define RO_CSI_ISP_AFIFO_BIST4B_PASS_SHIFT 21
#define RO_CSI_ISP_AFIFO_BIST4B_PASS_MASK (0x1f << 21)
#define RO_CSI_ISP_AFIFO_BIST4B_FAIL_SHIFT 26
#define RO_CSI_ISP_AFIFO_BIST4B_FAIL_MASK (0x1f << 26)

#define SENINF_TOP_AFIFOBIST_STATUS5 0x00b4
#define RO_CSI_ISP_AFIFO_BIST5A_DONE_SHIFT 0
#define RO_CSI_ISP_AFIFO_BIST5A_DONE_MASK (0x1 << 0)
#define RO_CSI_ISP_AFIFO_BIST5A_PASS_SHIFT 1
#define RO_CSI_ISP_AFIFO_BIST5A_PASS_MASK (0x1ff << 1)
#define RO_CSI_ISP_AFIFO_BIST5A_FAIL_SHIFT 10
#define RO_CSI_ISP_AFIFO_BIST5A_FAIL_MASK (0x1ff << 10)
#define RO_CSI_ISP_AFIFO_BIST5B_DONE_SHIFT 20
#define RO_CSI_ISP_AFIFO_BIST5B_DONE_MASK (0x1 << 20)
#define RO_CSI_ISP_AFIFO_BIST5B_PASS_SHIFT 21
#define RO_CSI_ISP_AFIFO_BIST5B_PASS_MASK (0x1f << 21)
#define RO_CSI_ISP_AFIFO_BIST5B_FAIL_SHIFT 26
#define RO_CSI_ISP_AFIFO_BIST5B_FAIL_MASK (0x1f << 26)
