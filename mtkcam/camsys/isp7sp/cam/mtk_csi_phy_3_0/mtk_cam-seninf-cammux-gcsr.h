...
#define RG_SENINF_CAM_MUX_EN_H_MASK (0xffff << 0)
...
#define RG_SENINF_CAM_MUX_CHK_EN_H_MASK (0xffff << 0)
...
#define RG_SENINF_CAM_MUX_GCSR_DYN_SWITCH_EN0_H_MASK (0xffff << 0)
...
#define RG_SENINF_CAM_MUX_GCSR_DYN_SWITCH_EN1_H_MASK (0xffff << 0)
...
#define RG_SENINF_CAM_MUX_VC_SEL_EN_H_MASK (0xffff << 0)
...
#define RG_SENINF_CAM_MUX_DT_SEL_EN_H_MASK (0xffff << 0)
...
#define RG_SENINF_CAM_MUX_HSIZE_ERR_IRQ_EN_H_MASK (0xffff << 0)
...
#define RG_SENINF_CAM_MUX_VSIZE_ERR_IRQ_EN_H_MASK (0xffff << 0)
...
#define RG_SENINF_CAM_MUX_GCSR_VSYNC_IRQ_EN_H_MASK (0xffff << 0)
...
#define RO_SENINF_CAM_MUX_HSIZE_ERR_IRQ_H_MASK (0xffff << 0)
