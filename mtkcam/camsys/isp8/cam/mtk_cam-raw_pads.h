...
static inline const char *raw_get_pad_name(unsigned int id)
{
	static const char * const names[] = {
		...
		_raw_pad_name(META_GMPO_OUT),
		_raw_pad_name(META_GRMGO_OUT),
	};
